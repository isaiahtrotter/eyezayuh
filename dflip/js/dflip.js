/******/ (function () {
  ...
  !(function () {
    ...
    /*VARIABLES*/ var has3d =
        "WebKitCSSMatrix" in window || (document.body && "MozPerspective" in document.body.style),
    ...
    var utils = (DV.utils = {
       ...
       */ getSharePrefixes: function getSharePrefixes() {
        return (DV.defaults.sharePrefix + ",dflip-,flipbook-,dearflip-,dearpdf-")
          .split(",")
          .map(function (e) {
            return e.trim();
          });
      ...
      httpsCorrection: function httpsCorrection(url) {
        try {
          ...
          var isSameDomain =
            urlHostName.replace("www.", "") === location.hostname.replace("www.", "");
      ...
      detectScriptLocation: function detectScriptLocation() {
        ...
        if (typeof window[defaults_DEARVIEWER.locationVar] == "undefined") {
          utils_jQuery("script").each(function () {
            ...
            if (
              (src.indexOf("/" + defaults_DEARVIEWER.locationFile + ".js") > -1 ||
                src.indexOf("/" + defaults_DEARVIEWER.locationFile + ".min.js") > -1 ||
                src.indexOf("js/" + defaults_DEARVIEWER.locationFile + ".") > -1) &&
      ...
      scrollIntoView: function scrollIntoView(element, reference, align) {
        ...
        reference.scrollTop =
          element.offsetTop + (align === false ? element.offsetHeight - reference.offsetHeight : 0);
        ...
        if (hash && hash.indexOf(prefix) >= 0 && defaults_DEARVIEWER.hashFocusBookFound === false) {
          ...
          if (id.length > 0) {
            ...
            if (
              ...
              var app =
                (defaults_DEARVIEWER.activeLightBox && defaults_DEARVIEWER.activeLightBox.app) ||
                book.data("df-app");
              if (app != null) {
                app.gotoPage(page);
    ...
    utils.focusHash = function (element) {
      ...
      (_element__scrollIntoView = (_element_ = element[0]).scrollIntoView) === null ||
      _element__scrollIntoView === void 0
        ? void 0
    ...
    utils.fallbackOptions = function (options) {
      ...
      if (options.share["mail"] === undefined) {
        options.share["mail"] =
          "mailto:?subject=" + options.text.mailSubject + "&body=" + options.text.mailBody;
      }
      if (options.openPage) {
    ...
    utils.urlify = function (text) {
      ...
      while ((result = myRegexp.exec(text))) {
        ...
        if ((url.match(/@/g) || []).length == 1) {
          ...
          url.match(/[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b[-a-zA-Z0-9@:%_\+.~#?&//=]*/g)
        ) {
      ...
      return text.replace(myRegexp, function (url, a, b) {
        if (url.indexOf("@") > -1) {
          ...
          if (url.match(/^((?!\.)[\w_.-]*[^.])(@\w+)(\.\w+(\.\w+)?[^.\W])$/gi)) {
            ...
            return (
              '<a href="' + url2 + '" ' + 'class="df-autolink" target="_blank">' + url + "</a>"
            );
          }
        } else {
    ...
    defaults_DEARVIEWER.parseThumbs = function (args) {
      ...
      var image = utils_jQuery(
        '<img width="210px" height="297px" class="df-lazy" alt="' + args.title + '"/>'
      );
    ...
    defaults_DEARVIEWER.parseNormalElements = function () {
        ...
        if (isParsed !== "true") {
          ...
          if (lightboxType === void 0) {
            ...
            if (lightboxType === "thumb") {
              var thumbLayout =
                element.data("df-thumb-layout") || defaults_DEARVIEWER.defaults.thumbLayout;
      ...
      defaults_DEARVIEWER.handleLazy = function () {
        ...
        if (
          defaults_DEARVIEWER.removeEmbeds.length <= defaults_DEARVIEWER.removeEmbedsLimit &&
            ...
            defaults_DEARVIEWER.checkRequestQueue = function () {
              ...
              if (defaults_DEARVIEWER.checkRequestQueue) {
                requestAnimationFrame(function () {
                  if (defaults_DEARVIEWER && defaults_DEARVIEWER.checkRequestQueue)
          ...
          value: function updateTemporaryScale() {
            ...
            if (reset === true) {
              ...
              this.parentElement[0].style.transformOrigin =
                this.app.viewer.zoomCenter.x + "px " + this.app.viewer.zoomCenter.y + "px";
        ...
        },
        {
          ...
          value: function mouseWheel(event) {
            ...
            var isValidZoomOption =
              app.options.mouseScrollAction === defaults_DEARVIEWER.MOUSE_SCROLL_ACTIONS.ZOOM &&
            ...
            if (isValidZoomKey || isValidZoomOption) {
              ...
              app.options.mouseScrollAction === defaults_DEARVIEWER.MOUSE_SCROLL_ACTIONS.NAV
            ) {
              if (delta > 0) {
                app.next();
              } else if (delta < 0) {
      ...
      reader_create_class(Reader, [
        ...
        },
        {
          ...
          value: function initScrollBar() {
            ...
            //solved #237
            this.scrollPageNumber = jQuery("<div class='df-reader-scroll-page-number'>").appendTo(
              this.app.container
            );
          },
        },
        {
          ...
          value: function afterControlUpdate() {
            ...
            if (this.app.provider.pageLabels) {
              ...
              this.scrollPageNumber[0].innerHTML =
                this.app.getCurrentLabel() + "<div>of " + this.app.pageCount + "</div>";
            }
          },
        },
        {
        ...
        },
        {
          ...
          value: function _getInnerHeight() {
            ...
            var maxWidth =
              this.app.dimensions.containerWidth - 20 - this.app.dimensions.padding.width;
            ...
            if (this.app.pageScaling === defaults_DEARVIEWER.PAGE_SCALE.PAGE_WIDTH)
              maxHeight = viewPort.height * 100;
            else if (this.app.pageScaling === defaults_DEARVIEWER.PAGE_SCALE.AUTO)
              maxHeight = viewPort.height * 1.5;
            else if (this.app.pageScaling === defaults_DEARVIEWER.PAGE_SCALE.ACTUAL)
        ...
        },
        {
          ...
          value: function handleZoom() {
            ...
            if (app.pendingZoom === true && app.zoomDelta != null) {
              ...
              zoomValue =
                delta > 0 ? zoomValue * app.options.zoomRatio : zoomValue / app.options.zoomRatio;
          ...
          value: function resize() {
            ...
            if (
              ...
              var top =
                  ...
                  (rect.top - rectParent.top + topVisiblePage.clientTop) * delta,
                left =
                  topVisiblePage.offsetLeft +
                  topVisiblePage.clientLeft -
                  (rect.left - rectParent.left + topVisiblePage.clientLeft) * delta;
              //10 is margin that zooms too and reset to 10
              top += ((delta - 1) * 10) / 2;
              left += ((delta - 1) * 10) / 2;
              var _this_zoomCenter;
              this.zoomCenter =
                (_this_zoomCenter = this.zoomCenter) !== null && _this_zoomCenter !== void 0
                  ? _this_zoomCenter
                  : {
                      x: 0,
    ...
    var BaseFlipBookViewer = /*#__PURE__*/ (function (BaseViewer) {
      ...
      function BaseFlipBookViewer(options, appContext) {
        ...
        _this.stackCount =
          (_options_stackCount = options.stackCount) !== null && _options_stackCount !== void 0
            ? _options_stackCount
            : 6;
        ...
        _this.pureMaxZoom = 4;
        if (
          _this.app.options.pageSize === defaults_DEARVIEWER.FLIPBOOK_PAGE_SIZE.AUTO ||
          _this.app.options.pageSize === defaults_DEARVIEWER.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL
        ) {
      ...
      flipbook_create_class(BaseFlipBookViewer, [
        {
          ...
          value: function init() {
            ...
            var app = this.app;
            this.pageMode =
              app.options.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.AUTO
        ...
        },
        {
          ...
          value: function determinePageMode() {
            ...
            if (this.app.pageCount < 3) {
              ...
              this.app.options.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.AUTO &&
              ...
              if (flipbook_utils.isMobile === true) {
                if (
                  ...
                  var compareWidth =
                    ...
                    (app.options.sideMenuOverlay != true && app.isSideMenuOpen ? 220 : 0);
                  this.pageMode =
                    singlePageModeHeight > doublePageModeHeight * 1.1 && compareWidth < 768
                      ? defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE
                      : defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.DOUBLE;
                  ...
                  var compareWidth1 =
                    ...
                    (app.options.sideMenuOverlay != true && app.isSideMenuOpen ? 220 : 0);
                  this.pageMode =
                    app.dimensions.stage.innerHeight > compareWidth1 * 1.1 && compareWidth1 < 768
                      ? defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE
                      : defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.DOUBLE;
                }
              }
        ...
        },
        {
          ...
          value: function checkDocumentPageSizes() {
            ...
            if (
              provider.pageSize === defaults_DEARVIEWER.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK ||
              provider.pageSize === defaults_DEARVIEWER.FLIPBOOK_PAGE_SIZE.DOUBLE
            ) {
        ...
        },
        {
          ...
          value: function isDoubleInternal() {
            return (
              this.app.provider.pageSize === defaults_DEARVIEWER.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL
            );
          },
        },
        {
        ...
        },
        {
          ...
          value: function isDoubleInternalPage(pageNumber) {
            return (
              this.isDoubleInternal() && pageNumber > 1 && pageNumber < this.app.provider.pageCount
            );
          },
        },
        {
            ...
            if (this.app.zoomValue > this.app.viewer.pureMaxZoom) {
              if (this.zoomViewer.leftViewPort)
                this.zoomViewer.leftPage.contentLayer[0].style.setProperty(
                  "--scale-factor",
                  this.zoomViewer.leftSheetHeight / this.zoomViewer.leftViewPort.height
                );
              if (this.zoomViewer.rightViewPort)
                this.zoomViewer.rightPage.contentLayer[0].style.setProperty(
                  "--scale-factor",
                  this.zoomViewer.rightSheetHeight / this.zoomViewer.rightViewPort.height
                );
            }
          },
        },
        ...
        },
        {
          ...
          value: function isSheetCover(sheetNumber) {
            ...
            return (
              ...
              sheetNumber ===
                Math.ceil(this.app.pageCount / (isBooklet ? 1 : 2)) - (isBooklet ? 0 : 1)
        ...
        },
        {
          ...
          value: function handleZoom() {
            ...
            this.pureMaxZoom =
              ...
              Math.max(leftDimen.height, leftDimen.width, rightDimen.height, rightDimen.width);
            var maxZoom = (this.maxZoom = app.options.fakeZoom * this.pureMaxZoom),
              zoomValue = app.zoomValue,
              zoomChanged = false,
              exitZoom = false,
              enterZoom = false;
          ...
          value: function refresh() {
            ...
            for (_sheetCount = 0; _sheetCount < stackCount; _sheetCount++) {
              ...
              viewer.refreshSheet({
                ...
                zIndex:
                  this.stackCount +
                  (_sheetCount < midPoint ? _sheetCount - midPoint : midPoint - _sheetCount),
                visible: isBooklet
                  ? isRTL
        ...
        },
        {
          ...
          value: function validatePageChange(pageNumber) {
            ...
            valid =
              valid ||
              (app.currentPageNumber < pageNumber && app.oldPageNumber < app.currentPageNumber);
            valid =
              valid ||
              (app.currentPageNumber > pageNumber && app.oldPageNumber > app.currentPageNumber);
            return valid;
        ...
        },
        {
          ...
          value: function mouseWheel(event) {
            if (
              this.app.options.mouseScrollAction === defaults_DEARVIEWER.MOUSE_SCROLL_ACTIONS.ZOOM
            ) {
        ...
        },
        {
          ...
          value: function getAnnotationElement(pageNumber) {
            var clean = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
              isZoomViewer = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        ...
        },
        {
          ...
          value: function setPageMode(args) {
            ...
            // this.requestRefresh();
            if (
              app.viewer.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.DOUBLE &&
        ...
        },
        {
          ...
          value: function updatePageMode() {
            ...
            this.isBooklet =
              this.isSingle &&
              this.singlePageMode === defaults_DEARVIEWER.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET;
        ...
        },
        {
          ...
          value: function _getInnerHeight() {
            ...
            this.app.dimensions.stage.width =
              this.app.dimensions.stage.innerWidth + this.app.dimensions.padding.width;
        ...
        },
        {
          ...
          value: function availablePageWidth() {
            var zoom = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true,
              ignoreSidemenuOverlay =
                arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
              singleMode = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : void 0;
            if (singleMode === void 0) {
              singleMode = this.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE;
            }
        ...
        },
        {
          ...
          value: function availablePageHeight() {
            var zoom = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true,
              singleMode = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
            if (singleMode === void 0) {
              singleMode = this.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE;
            }
          ...
          value: function filterViewPortCanvas(viewport, canvas, pageNumber) {
            if (this.isDoublePageFix(pageNumber)) {
              viewport.transform[4] =
                viewport.transform[4] -
                Math.floor(Math.min(canvas.width, viewport.width * 2 - canvas.width));
            }
        ...
        },
        {
          ...
          value: function isClosedPage(pageNumber) {
            ...
            return (
              pageNumber === 1 ||
              (pageNumber ===
                this.app.jumpStep * Math.ceil(this.app.pageCount / this.app.jumpStep) &&
                !this.isBooklet)
            );
    ...
    var ZoomViewer = /*#__PURE__*/ (function (BaseViewer) {
      ...
      flipbook_create_class(ZoomViewer, [
        ...
        },
        {
          ...
          value: function initEvents() {
            this.stageDOM = this.element[0];
            flipbook_get(flipbook_get_prototype_of(ZoomViewer.prototype), "initEvents", this).call(
              this
            );
          },
        },
          ...
          value: function resize() {
            ...
            var zoomHeight = this.app.viewer.availablePageHeight(),
              ...
              zoomFullWidth = (viewer.fullWidth =
                zoomWidth *
                (this.app.viewer.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE
                  ? 1
                  : 2)),
            ...
            var shiftHeight = (viewer.shiftHeight = Math.ceil(
                flipbook_utils.limitAt((zoomHeight - stageHeight) / 2, 0, zoomHeight)
              )),
              shiftWidth = (viewer.shiftWidth = Math.ceil(
                flipbook_utils.limitAt((zoomFullWidth - stageWidth) / 2, 0, zoomFullWidth)
              ));
        ...
        },
        {
          ...
          value: function pagesReady() {
            ...
            if (this.app.options.flipbookFitPages === false) {
              ...
              var leftViewPort = (this.leftViewPort = this.app.viewer.getViewPort(
                  basePage + (this.app.viewer.isBooklet ? 0 : this.app.viewer.isRTL ? 1 : 0)
                )),
                rightViewPort = (this.rightViewPort = this.app.viewer.getViewPort(
                  basePage + (this.app.viewer.isBooklet ? 0 : this.app.viewer.isRTL ? 0 : 1)
                ));
              if (leftViewPort) {
                ...
                this.leftSheetTop =
                  (this.app.viewer.availablePageHeight() - this.leftSheetHeight) / 2;
                if (this.app.zoomValue > this.app.viewer.pureMaxZoom)
              ...
              if (rightViewPort) {
                ...
                this.rightSheetTop =
                  (this.app.viewer.availablePageHeight() - this.rightSheetHeight) / 2;
                if (this.app.zoomValue > this.app.viewer.pureMaxZoom)
      ...
      flipbook_2d_create_class(BookSheet2D, [
        ...
        },
        {
          ...
          value: function updateSize(width, height, top) {
            ...
            this.wrapper[0].style.height = this.wrapper[0].style.width =
              Math.ceil(flipbook_2d_utils.distOrigin(width, height) * this.viewer.app.zoomValue) +
              "px";
              ...
              if (point == null) {
                ...
                flipDuration =
                  (sheet.viewer.app.options.duration *
                    flipbook_2d_utils.distPoints(init.x, init.y, end.x, end.y)) /
        ...
        },
        {
          ...
          value: function updatePoint(point) {
            ...
            point.rx =
              isRight === true ? sheet.viewer.leftSheetWidth + pageWidth - point.x : point.x;
            point.ry = isBottom === true ? pageHeight - point.y : point.y;
            var radAngle = Math.atan2(point.ry, point.rx);
            radAngle =
              Math.PI / 2 - flipbook_2d_utils.limitAt(radAngle, 0, flipbook_2d_utils.toRad(90));
            ...
            var foldOpacity = flipbook_2d_utils.limitAt(
              ((sheet.viewer.leftSheetWidth + pageWidth - point.rx) * 0.5) / pageWidth,
              0.05,
              0.3
            );
            ...
            sheet.wrapper.css({
              transform:
                flipbook_2d_utils.translateStr(x1, y1) + flipbook_2d_utils.rotateStr(angle1),
            });
            back.css({
              transform:
                flipbook_2d_utils.rotateStr(-angle1) + flipbook_2d_utils.translateStr(-x1, -y1),
            });
            front.css({
              transform:
                flipbook_2d_utils.rotateStr(angle2) + flipbook_2d_utils.translateStr(x2, y2),
            ...
            sheet.backPage.updateCSS({
              display:
                isRight === true
                  ...
                  : "none",
              transform:
                (flipbook_2d_utils.prefix.dom !== "MfS" ? "" : "perspective(" + width + "px) ") +
            ...
            sheet.frontPage.updateCSS({
              display:
                isRight === true
                  ...
                  : "none",
              transform:
                (flipbook_2d_utils.prefix.dom !== "MSd" ? "" : "perspective(" + width + "px) ") +
    ...
    var FlipBook2D = /*#__PURE__*/ (function (BaseFlipBookViewer) {
      ...
      function FlipBook2D(options, appContext) {
        ...
        options.viewerClass =
          (_options_viewerClass = options.viewerClass) !== null && _options_viewerClass !== void 0
      ...
      flipbook_2d_create_class(FlipBook2D, [
        {
          key: "init",
          value: function init() {
            flipbook_2d_get(flipbook_2d_get_prototype_of(FlipBook2D.prototype), "init", this).call(
              this
            );
            this.initEvents();
            this.initPages();
        ...
        },
        {
          ...
          value: function updateCenter() {
            ...
            var end = (centerShift * width) / 2;
            viewer.seamPosition =
              (-viewer.app.dimensions.offset.width + viewer.app.dimensions.containerWidth) / 2 +
              end;
            viewer.wrapperShift =
              (viewer.isSingle ? -viewer.app.dimensions.stage.innerWidth / 2 : 0) + end;
        ...
        },
        {
          ...
          value: function eventToPoint(event) {
            ...
            if (viewer.dragSheet)
              isRight = viewer.dragSheet.side === flipbook_2d_DV.TURN_DIRECTION.RIGHT;
            else {
      ...
      slider_create_class(Slider, [
        ...
        },
        {
          ...
          value: function refreshSheet(options) {
            ...
            _sheet.updateCSS({
              display:
                options.sheetNumber > 0 && options.sheetNumber <= this.app.pageCount
                  ? "block"
                  : "none",
              zIndex: options.zIndex,
            });
        ...
        },
        {
          ...
          value: function setPageMode(args) {
            args.isSingle = true;
            slider_get(slider_get_prototype_of(Slider.prototype), "setPageMode", this).call(
              this,
              args
            );
          },
      ...
      flipbook_3d_create_class(BookSheet3D, [
        ...
        },
        {
          ...
          value: function updateAngle() {
            ...
            var width =
              (this.viewer.orientation === "vertical" ? this.height : this.width) *
              (1 - Math.sin((flexibility / 2) * (flexibility / 2)) / 2 - flexibility / 20);
            this.element.scale.y =
              (this.viewer.orientation === "vertical" ? this.width : this.height) /
            ...
            // }
            var curveAngle =
              sheet.isHard === true ? sheetAngle : (sheet.curveAngle * Math.PI) / 180; // the angle at which curve will form due to curve handle point
...
*/ var bodyG = sheet.element.geometry;
            if (bodyG.attributes !== void 0) {
              ...
              for (var fold1 = 0; fold1 < foldCount; fold1++) {
                for (var count1 = 1; count1 < segments; count1++) {
                  ...
                  verts[offset1 + rowVertices1].z = verts[offset1 + rowVertices1 * 2].z =
                    verticesFront[0][count1].z;
                  verts[offset1 + rowVertices1].x = verts[offset1 + rowVertices1 * 2].x =
                    verticesFront[0][count1].x;
                  offset1++;
                }
              }
        ...
        },
        {
          ...
          value: function flip(oldAngle, newAngle) {
            ...
            var coverAdjustmentWidth = -(sheet.viewer.has3DCover && sheet.viewer.isClosedPage()
                ? sheet.viewer.coverExtraWidth
                : 0),
              coverAdjustmentHeight = -(sheet.viewer.has3DCover && sheet.viewer.isClosedPage()
            ...
            var update = function update(tween) {
              ...
              if (sheet.isHard === true) {
                ...
                sheet.flexibility =
                  tween.angle < 90 ? sheet.leftFlexibility : sheet.rightFlexibility;
              }
              sheet.element.position.z =
                (tween.angle < 90 ? sheet.leftPos : sheet.rightPos) + sheet.depth;
              if (isBooklet) {
    ...
    var FlipBook3D = /*#__PURE__*/ (function (BaseFlipBookViewer) {
      ...
      function FlipBook3D(options, appContext) {
        ...
        _this.flexibility = flipbook_3d_utils.limitAt(
          (_options_flexibility = options.flexibility) !== null && _options_flexibility !== void 0
        ...
        _this.color3DSheets =
          (_this_app_options_color3DSheets = _this.app.options.color3DSheets) !== null &&
      ...
      flipbook_3d_create_class(FlipBook3D, [
        ...
        },
        {
          ...
          value: function init() {
            var app = this.app;
            flipbook_3d_get(flipbook_3d_get_prototype_of(FlipBook3D.prototype), "init", this).call(
              this
            );
        ...
        },
        {
          ...
          value: function updatePageMode() {
            ...
            var app = this.app;
            this.has3DCover =
              app.options.cover3DType !== defaults_DEARVIEWER.FLIPBOOK_COVER_TYPE.NONE &&
              app.pageCount > 7 &&
              !this.isBooklet;
        ...
        },
        {
          ...
          value: function initDepth() {
            ...
            this.sheetDepth =
              this.pageScaleX *
              ((_this_app_options_sheetDepth = this.app.options.sheetDepth) !== null &&
              _this_app_options_sheetDepth !== void 0
                ? _this_app_options_sheetDepth
                : 0.5);
            var _this_app_options_sheetSegments;
            this.sheetSegments =
              (_this_app_options_sheetSegments = this.app.options.sheetSegments) !== null &&
        ...
        },
        {
          ...
          value: function resize() {
            ...
            this.coverExtraWidth = (viewer.orientation == "vertical" ? 2 : 1) * ref * 0.025;
            this.coverExtraHeight = (viewer.orientation == "vertical" ? 1 : 2) * ref * 0.025;
            ...
            this.pageOffset =
              ((this.hasSpiral ? 6 : 0) *
                Math.min(this._defaultPageSize.width, this._defaultPageSize.height)) /
              1000;
          },
        },
        {
        ...
        },
        {
          ...
          value: function refresh() {
            ...
            var isLeftClosed = (this.isLeftClosed =
                this.isClosedPage() && ((isRTL && isLastPage) || (!isRTL && isFrontPage))),
            ...
            if (displayCover) {
              ...
              depthLeft -=
                viewer.coverDepth +
                (viewer.leftSheets.element.visible ? viewer.leftSheets.depth / 2 : 0) +
                viewer.coverDepth * 3;
              ...
              if (viewer.leftCover.isFlipping !== true) {
                ...
                if (viewer.rightCover.isFlipping !== true) {
                  ...
                  viewer.leftCover.width =
                    viewer.leftCover.sheetAngle < 90 ? this.leftSheetWidth : this.rightSheetWidth;
                  if (!this.isClosedPage()) {
              ...
              depthRight -=
                viewer.coverDepth +
                (viewer.rightSheets.element.visible ? viewer.rightSheets.depth / 2 : 0) +
                viewer.coverDepth * 3;
              if (viewer.rightCover.isFlipping !== true) {
                ...
                viewer.rightSheets.sheetAngle = viewer.rightCover.sheetAngle = isRightClosed
                  ? 0
                  : 180;
                viewer.rightSheets.curveAngle = viewer.rightCover.curveAngle = isRightClosed
                  ? 0
                  : 180;
                if (viewer.leftCover.isFlipping !== true) {
                  viewer.rightCover.height = maxSheetHeight;
                  viewer.rightCover.width =
                    viewer.rightCover.sheetAngle < 90 ? this.leftSheetWidth : this.rightSheetWidth;
                  if (!this.isClosedPage()) {
              ...
              viewer.stage.ground.position.z =
                Math.min(depthLeft, depthRight) - (viewer.refSize * viewer.groundDistance) / 100;
              // if (this.isClosedPage()) {
            ...
            if (_sheet.isFlipping === false) {
              if (options.needsFlip) {
                ...
                _sheet.element.position.z =
                  Math.max(oldAngle < 90 ? _sheet.leftPos : _sheet.rightPos, viewer.midPosition) +
                  viewer.sheetDepth;
                //this.beforeFlip();
                _sheet.flexibility =
                  oldAngle < 90 ? _sheet.leftFlexibility : _sheet.rightFlexibility;
                _sheet.flip(oldAngle, newAngle);
              } else {
                _sheet.skipFlip = false;
                _sheet.sheetAngle = _sheet.curveAngle = newAngle;
                _sheet.flexibility =
                  newAngle < 90 ? _sheet.leftFlexibility : _sheet.rightFlexibility;
        ...
        },
        {
          ...
          value: function updateCenter() {
            ...
            viewer.seamPosition =
              (-app.dimensions.offset.width + app.dimensions.containerWidth) / 2 + end;
        ...
        },
        {
          ...
          value: function pagesReady() {
            ...
            if (this.app.options.flipbookFitPages === false) {
              ...
              if (this.isClosedPage()) {
                var isClosedOnRight =
                  (this.isRTL && this.isLastPage()) || (!this.isRTL && this.isFirstPage());
                ...
                this.leftCover.height = this.rightCover.height =
                  this.coverExtraHeight + Math.max(this.leftSheetHeight, this.rightSheetHeight);
          ...
          value: function mouseDown(event) {
            ...
            if (event.touches != null && event.touches.length === 2) {
              ...
              var edgeDistance = point.sheet
                ? point.sheet.width -
                  Math.abs(point.x - (this.app.dimensions.origin.x + viewer.centerEnd))
                : 0;
              if (
                point.sheet &&
                object &&
        ...
        },
        {
          ...
          value: function getPageByNumber(pageNumber) {
            if (this.has3DCover) {
              var isLastPage =
                  !this.isBooklet && pageNumber === this.app.pageCount && pageNumber % 2 === 0,
    ...
    FlipBook3D.prototype.updateCSSLayer = function () {
      ...
      var pageLeft =
          !this.isRTL && viewer.isBooklet ? undefined : viewer.getPageByNumber(leftPageNumber),
        pageRight =
          this.isRTL && viewer.isBooklet ? undefined : viewer.getPageByNumber(rightPageNumber);
    ...
    FlipBook3D.prototype.initSpiral = function () {
      ...
      var material = new THREE.MeshPhongMaterial({
        color:
          (_this_app_options_spiralColor = this.app.options.spiralColor) !== null &&
          _this_app_options_spiralColor !== void 0
    ...
    FlipBook3D.prototype.refreshSpiral = function () {
      ...
      this.leftHoles.position.z = this.rightHoles.position.z =
        maxPos + 2 / scale + (this.isClosedPage() ? 2 * this.leftCover.depth : 0) / scale; //(this.isBooklet ? 4 : 0) + (this.isClosedPage() ? 5 : 0);
    ...
    var HybridFlipbook3D = /*#__PURE__*/ (function (FlipBook3D) {
      ...
      function HybridFlipbook3D(options, appContext) {
        ...
        options.flexibility = 0;
        if (
          options.cover3DType === defaults_DEARVIEWER.FLIPBOOK_COVER_TYPE.RIDGE ||
          ...
          value: function customNavigateTo(dest) {
            ...
            if (!isNaN(Math.floor(dest))) {
              ...
              if (isNaN(pageNumber)) {
                window.open(
                  dest,
                  this.pdfApp.options.linkTarget === defaults_DEARVIEWER.LINK_TARGET.SELF
                    ? "_self"
                    : "_blank"
                );
                return;
          ...
          value: function getDestinationHash(dest) {
            ...
            if (provider_instanceof(dest, Array)) {
              ...
              if (pageNumber) {
                ...
                var destKind = dest[1];
                if (
                  (typeof destKind === "undefined" ? "undefined" : provider_type_of(destKind)) ===
                    "object" &&
                  "name" in destKind &&
                  destKind.name === "XYZ"
                ) {
        ...
        },
        {
          ...
          value: function _documentLoaded() {
            ...
            if (this.app && this.app.dimensions && this.app.dimensions.pageFit === undefined)
              provider_utils.log("Provider needs to initialize page properties for the app");
    ...
    var PDFDocumentProvider = /*#__PURE__*/ (function (DocumentProvider) {
      ...
      function PDFDocumentProvider(props, context) {
            ...
            provider_utils.getScript(
              ...
              function () {
                if (
                  ...
                  window.require(["pdfjs-dist/build/pdf"], function (pdfjsLib1) {
        ...
        provider.cacheBustParameters =
          "?ver=" + defaults_DEARVIEWER.version + "&pdfver=" + app.options.pdfVersion;
        ...
        },
        {
          ...
          value: function loadDocument() {
            ...
            pdfLoadProcess.promise
              ...
              .catch(function (error) {
                if (app !== null && app.options != null) {
                  ...
                  var fileName =
                    ((_app_options = app.options) === null || _app_options === void 0
                      ? void 0
            ...
            pdfLoadProcess.getTotalLength = function () {
              return provider.pdfLoadProgress._transport._networkStream._fullRequestReader
                .contentLength;
            };
              ...
              if (app !== null) {
                ...
                if (isNaN(percentage)) {
                    ...
                    if (
                      ...
                      app.updateInfo(
                        app.options.text.loading +
                          " PDF " +
                          (Math.ceil(progressData.loaded / 10000) / 100).toFixed(2).toString() +
                          "MB ..."
                      );
                    }
                  } else {
                  ...
                  app.updateInfo(
                    app.options.text.loading +
                      " PDF " +
                      Math.ceil(Math.min(100, percentage)).toString().split(".")[0] +
                      "% ..."
                  );
                }
              }
            ...
            provider.pdfDocument
              ...
              .then(function (pdfPage) {
                ...
                if (param.isFreshPage) {
                  ...
                  (_app_viewer_getPageByNumber = app.viewer.getPageByNumber(param.pageNumber)) ===
                  ...
                  .then(function () {
                    ...
                    if (app.options.cleanupAfterRender === true) {
                      ...
                      if (provider.requestedPages.indexOf(checkString) > -1) {
                        ...
                        if (
                          provider.requestedPages.indexOf("[" + pdfPageNumberToRender + "|") == -1
                        ) {
                          provider_utils.log(
                            "CleanUp Passed for (" +
                              pageNumber +
            ...
            provider.document.getPage(pdfPageNumberToRender).then(function (page) {
              ...
              if (param.preferCanvas === true) {
                ...
                context.drawImage(
                  ...
                  0,
                  renderContext.canvas.width *
                    ((_renderContext_viewport_widthFix = renderContext.viewport.widthFix) !==
                      null && _renderContext_viewport_widthFix !== void 0
      ...
      controls_create_class(UI, [
        {
          ...
          value: function init() {
            ...
            /*PAGEMODE/PAGEFIT*/ if (app.viewer.isFlipBook) {
              if (app.pageCount > 2) {
                var isSingle =
                  app.viewer.pageMode === defaults_DEARVIEWER.FLIPBOOK_PAGE_MODE.SINGLE;
            ...
            if (
              ...
              controls.download
                .attr("href", controls_utils.httpsCorrection(app.options.source))
            ...
            if (!(app.options.isLightBox === true && app.fullscreenSupported !== true)) {
              this.fullScreen = controls.fullScreen = controls_utils
                .createBtn("fullscreen", icons["fullscreen"], text.toggleFullscreen)
            ...
            for (var controlCount = 0; controlCount < allControls.length; controlCount++) {
              ...
              if (hideControls.indexOf("," + controlName + ",") < 0) {
                ...
                if (
                  control != null &&
                  (typeof control === "undefined" ? "undefined" : controls_type_of(control)) ==
                    "object"
                ) {
                  if (
        ...
        },
        {
          ...
          value: function closePanels(event) {
            if (this.moreContainerOpen === true) {
              ...
              (_this_controls_more = this.controls.more) === null || _this_controls_more === void 0
                ? void 0
          ...
          value: function update() {
            ...
            if (this._pageLabelWidthSet !== true) {
              ...
              if (app.provider.pageLabels) {
                this.pageLabel.html(
                  "88888888888888888".substring(0, app.pageCount.toString().length * 3 + 4)
                );
              } else {
                this.pageLabel.html(
                  "88888888888".substring(0, app.pageCount.toString().length * 2 + 3)
                );
              }
            ...
            if (pageLabel.toString() !== app.currentPageNumber.toString()) {
              controls.pageLabel.html(
                pageLabel + "(" + app.currentPageNumber + "/" + app.pageCount + ")"
              );
            } else {
            ...
            var isSearchOpen =
              ...
              app.container.find(".df-sidemenu-visible.df-search-container").length > 0;
            ...
            if (isSearchOpen) {
              ...
              if (targetSearchresult.length > 0 && !targetSearchresult.hasClass(".df-active")) {
                ...
                if (
                  ...
                  controls_utils.scrollIntoView(targetSearchresult, null, false);
              ...
              if (
                ...
                if (shareTemplate !== null) {
                  dfShare[shareKey] = controls_jQuery("<div>", {
                    class:
                      shareButtonClass + " df-share-" + shareKey + " " + options.icons[shareKey],
                  }).on("click", function (e) {
                    e.preventDefault();
                    window.open(
                      shareTemplate
                        .replace("{{url}}", encodeURIComponent(dfShare.shareUrl))
    ...
    var DVLightBox = /*#__PURE__*/ (function () {
      ...
      function DVLightBox(closeCallback) {
        ...
        lightbox.closeButton = controls_jQuery("<div>")
          .addClass("df-lightbox-close df-ui-btn " + defaults_DEARVIEWER.defaults.icons["close"])
          .on("click", function () {
      ...
      controls_create_class(ThumbList, [
        {
          ...
          value: function processThumbRequest() {
            ...
            if (app.activeThumb !== app.currentPageNumber) {
              var thumbVisible =
                app.thumbContainer != null && app.thumbContainer.hasClass("df-sidemenu-visible");
              if (thumbVisible) {
        ...
        if (defaults_DEARVIEWER.activeLightBox.app === null) {
          defaults_DEARVIEWER.activeLightBox.show(function () {
            ...
            defaults_DEARVIEWER.activeLightBox.lightboxWrapper.toggleClass(
              "df-lightbox-padded",
              defaults_DEARVIEWER.activeLightBox.app.options.popupFullsize === false
            );
            defaults_DEARVIEWER.activeLightBox.lightboxWrapper.toggleClass(
              "df-rtl",
            ...
            defaults_DEARVIEWER.activeLightBox.backGround.css({
              backgroundColor:
                defaults_DEARVIEWER.activeLightBox.app.options.backgroundColor === "transparent"
                  ? defaults_DEARVIEWER.defaults.popupBackGroundColor
                  : defaults_DEARVIEWER.activeLightBox.app.options.backgroundColor,
            });
          });
        }
      }
    ...
    defaults_DEARVIEWER.openFile = function (file) {
      if (file) {
        ...
        (_DEARVIEWER_openFileSelected = defaults_DEARVIEWER["openFileSelected"]) === null ||
    ...
    var App = /*#__PURE__*/ (function () {
      ...
      function App(options) {
        ...
        this.isExternalReady =
          (_this_options_isExternalReady = this.options.isExternalReady) !== null &&
          _this_options_isExternalReady !== void 0
      ...
      app_create_class(App, [
          ...
          value: function initDOM() {
            ...
            this.container.addClass(
              "df-container df-loading df-init" +
                ...
                (app_utils.isIOS === true || app_utils.isIPad === true ? " df-ios" : "")
            );
          ...
          value: function initResourcesLocation() {
            ...
            if (typeof window[defaults_DEARVIEWER.locationVar] !== "undefined") {
              ...
              options.pdfjsWorkerSrc =
                window[defaults_DEARVIEWER.locationVar] + "js/libs/pdf.worker.min.js";
              options.soundFile = window[defaults_DEARVIEWER.locationVar] + options.soundFile;
              options.imagesLocation =
                window[defaults_DEARVIEWER.locationVar] + options.imagesLocation;
              options.imageResourcesPath =
                window[defaults_DEARVIEWER.locationVar] + options.imageResourcesPath;
        ...
        },
        {
          ...
          value: function softInit() {
            ...
            app.provider = new defaults_DEARVIEWER.providers[app.options.providerType](
              app.options,
              app
            );
        ...
        },
        {
          ...
          value: function dispose() {
            ...
            app.info = null;
            (_app_loadingIcon = app.loadingIcon) === null || _app_loadingIcon === void 0
              ? void 0
              : _app_loadingIcon.remove();
            app.loadingIcon = null;
            (_app_backGround = app.backGround) === null || _app_backGround === void 0
              ? void 0
            ...
            (_app_commentPopup = app.commentPopup) === null || _app_commentPopup === void 0
              ? void 0
        ...
        },
        {
          ...
          value: function initOutline() {
            ...
            outlineContainer.append(
              '<div class="df-sidemenu-title">' + this.options.text.outlineTitle + "</div>"
            );
        ...
        },
        {
          ...
          value: function initThumbs() {
            ...
            thumbContainer.append(
              '<div class="df-sidemenu-title">' + this.options.text.thumbTitle + "</div>"
            );
        ...
        },
        {
          ...
          value: function initSearch() {
            ...
            searchContainer.append(
              '<div class="df-sidemenu-title">' + this.options.text.searchTitle + "</div>"
            );
            ...
            app.searchButton = app_jQuery('<div class="df-ui-btn df-search-btn df-icon-search">')
              .on("click", function (event) {
                app.search();
              })
              .appendTo(app.searchForm);
            ...
            app.searchResults = app_jQuery('<div class="df-wrapper df-search-results">').appendTo(
              searchContainer
            );
        ...
        },
        {
          ...
          value: function calculateLayout() {
            ...
            padding.top =
              ...
              (app.options.controlsPosition === defaults_DEARVIEWER.CONTROLS_POSITION.TOP
                ? controlsHeight
                : 0);
            ...
            padding.bottom =
              ...
              (app.options.controlsPosition === defaults_DEARVIEWER.CONTROLS_POSITION.BOTTOM
                ? controlsHeight
                : 0);
            ...
            dimensions.maxHeight =
              ...
              (dimensions.containerWidth > 600
                ? (_jQuery_height = app_jQuery(
                    (_app_options_headerElementSelector = app.options.headerElementSelector) !==
                      null && _app_options_headerElementSelector !== void 0
          ...
          value: function switchFullscreen() {
            ...
            if (
              app === null || app === void 0
                ...
                ? void 0
                : (_app_ui_controls = _app_ui.controls) === null || _app_ui_controls === void 0
                ? void 0
    ...
    PDFDocumentProvider.prototype.processTextContent = function (pageNumber, element) {
      ...
      var createAutoLinks =
        app.options.enableAnnotation === true && app.options.enableAutoLinks === true;
    ...
    PDFDocumentProvider.prototype.renderAutoLinks = function (
      ...
      if (autoLinkItems && autoLinkItems.length > 0) {
        ...
        taskPromise.then(function (data) {
          var _task_textDivs;
          var divs =
            (_task_textDivs = task.textDivs) !== null && _task_textDivs !== void 0
              ? _task_textDivs
              : task._textDivs;
          divs.forEach(function (div) {
            ...
            for (_searchPart = 0; _searchPart < item.searchHits.length; _searchPart++) {
              ...
              if (text.indexOf("@") > 0) {
                ...
                _html +=
                  '<a href="' + url + '" ' + 'class="df-autolink" target="_blank">' + text + "</a>";
              } else {
                if (url.indexOf("www.") === 0) {
                  url = "http://" + url;
                }
    ...
    defaults_DEARVIEWER.getPDFThumb = function (options) {
      ...
      var pdfDoc = progress.promise.then(function (pdf) {
        pdf.getPage(1).then(function (pdfPage) {
          ...
          pageRendering.promise.then(function () {
            ...
            (_options_callback = options.callback) === null || _options_callback === void 0
              ? void 0
      ...
      progress.onProgress = function getDocumentProgress(progressData) {
        ...
        if (isNaN(percentage)) {
          ...
          options.updateInfo(
            "Loading PDF " + Math.ceil(percentage).toString().split(".")[0] + "% ..."
          );
        }
        // }
      };
    ...
    var updateOptions = function updateOptions(options) {
      ...
      if (options.pageSize !== void 0) {
        if (
          ...
          options.pageSize = dflip_pro_DEARFLIP.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL;
        } else if (options.pageSize === dflip_pro_DEARFLIP.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK) {
        } else {
    ...
    dflip_pro_jQuery(document).ready(function () {
      ...
      body.on(
        ...
        function (event) {
          ...
          } else if (target == void 0 && dflip_pro_DEARFLIP.defaults.targetWindow === "_self") {
