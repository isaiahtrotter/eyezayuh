          ...
          (this.to = function (e, t) {
            ...
            (this.start = function (s) {
              ...
              o)) {
                ...
                null != i[r] &&
                  ((i[r] = e[r]), !1 === n(i[r], Array) && (i[r] *= 1), (a[r] = i[r] || 0));
              }
              return this;
            }),
            (this.stop = function () {
              return (
                h && (t.remove(this), (h = !1), null != w && w.call(e), this.stopChainedTweens()),
                this
              );
            }),
            ...
            (this.complete = function () {
              return (
                h &&
                  (t.remove(this), (h = !1), null != b && b.call(e), this.completeChainedTweens()),
                this
              );
            }),
            ...
            Utils: {
              ...
              CatmullRom: function (e, t, i, n, o) {
                var a = (i - e) * 0.5,
                  ...
                  r = o * o;
                return (
                  o * r * (2 * t - 2 * i + a + s) + (-3 * t + 3 * i - 2 * a - s) * r + a * o + t
                );
              },
            },
          }),
  ...
  (i.amdO = {}),
    (function () {
      ...
      var a = n.jQuery,
        ...
        l = (n.utils = {
          ...
          getSharePrefixes: function () {
            return (n.defaults.sharePrefix + ",dflip-,flipbook-,dearflip-,dearpdf-")
              .split(",")
              .map(function (e) {
                return e.trim();
              });
          ...
          createBtn: function (e, t, i) {
            ...
            return (
              void 0 !== t && t.indexOf("<svg") > -1
                ? n.html(t.replace("<svg", '<svg xmlns="http://www.w3.org/2000/svg" '))
                : n.addClass(t),
              n
            );
          },
            ...
            try {
              ...
              e.split("://")[1].split("/")[0].replace("www.", "") ===
                ...
                (t.href.indexOf("https://") > -1
                  ...
                  : t.href.indexOf("http://") > -1 && (e = e.replace("https://", "http://")),
          ...
          getMouseDelta: function (e) {
            var t = 0;
            return (
              null != e.wheelDelta ? (t = e.wheelDelta) : null != e.detail && (t = -e.detail), t
            );
          },
          pan: function (e, t) {
      ...
      (l.removeNullCharacters = function (e) {
              ...
              if (t && t.indexOf(e) >= 0 && !1 === n.hashFocusBookFound) {
                ...
                if (i.length > 0) {
                  ...
                  if (
                    ...
                    if (null != r)
                      return (
                        r.gotoPage(s), (r.hashNavigationEnabled = !0), l.focusHash(r.element), !1
                      );
                    null != s && o.attr("data-hash-page", s),
                      o.addClass("df-hash-focused", !0),
                      null != o.data("lightbox") || null != o.data("df-lightbox")
                        ? o.trigger("click")
                        : null != o.attr("href") &&
        ...
        (l.focusHash = function (e) {
          ...
          null === (t = (i = e[0]).scrollIntoView) ||
            void 0 === t ||
            t.call(i, { behavior: "smooth", block: "nearest", inline: "nearest" });
        }),
        ...
        (l.fallbackOptions = function (e) {
          return (
            void 0 === e.share.mail &&
              (e.share.mail = "mailto:?subject=" + e.text.mailSubject + "&body=" + e.text.mailBody),
      ...
      (l.getOptions = function (e) {
        (void 0 == (e = a(e)).data("df-option")) & (void 0 == e.data("option")) &&
          ...
          return (
            e
              ? ((i = t > 135 ? 180 - (180 - t) * 2 : t > 45 ? t - 45 : 0),
                (i = l.limitAt(i, n, 180)))
              : ((i = t < 45 ? 2 * t : t < 135 ? t + 45 : 180), (i = l.limitAt(i, 0, 180 - n))),
            i
          );
        }),
        (l.sanitizeOptions = function (e) {
          var t, i;
          if (
            ((e.showDownloadControl = l.parseBoolIfExists(e.showDownloadControl)),
            ...
            null != e.source &&
              (Array === e.source.constructor ||
                ...
                ((t = e.source),
                null != (i = Array) && "undefined" != typeof Symbol && i[Symbol.hasInstance]
        ...
        a(".dvcss").each(function () {
          var e,
            ...
            i = (function (e) {
              for (
                var t,
                  i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "dvcss_e_",
                  n = e.classList,
                  o = 0;
                o < n.length;
                o++
          ...
          if (e) {
            ...
            (window[n] = a.extend(!0, {}, window[n], e)),
              ...
              "none" !== e.lightbox &&
                (t.attr("data-df-lightbox", void 0 === e.lightbox ? "custom" : e.lightbox),
        ...
        (n.parseThumbs = function (e) {
          ...
          s.attr("data-src", e.thumbURL),
            ...
            "book-title-top" === e.thumbLayout
              ...
              : ("book-title-bottom" === e.thumbLayout || "cover-title" === e.thumbLayout) &&
                (e.hasShelf ? (e.thumbLayout = "book-title-fixed") : t.appendTo(e.element),
                !0 === n.defaults.displayLightboxPlayIcon &&
                  (e.element.removeClass("df-icon-play-popup"), i.addClass("df-icon-play-popup"))),
            ...
            a(".df-element").each(function () {
              ...
              if ("true" !== e.attr("skip-parse") && "true" !== e.data("df-parsed")) {
                ...
                if (void 0 === t) e.addClass("df-lazy-embed"), n.addLazyElement(e[0]);
                  ...
                  n.parseThumbs({ element: e, thumbURL: o, title: s, thumbLayout: i, hasShelf: r }),
        ...
        "function" == typeof IntersectionObserver &&
          (n.lazyObserver = new IntersectionObserver(function (e, t) {
            e.forEach(function (e) {
              ...
              e.isIntersecting
                ? (!i.attr("initID") &&
                    (i.attr("initID", n.initId), (o = n.initId.toString()), n.initId++),
                  (t = n.removeEmbeds.indexOf(o)) > -1
                    ? (n.removeEmbeds.splice(t, 1), l.log("Removed id " + o + "from Removal list"))
                    : -1 == (t = n.embeds.indexOf(o)) &&
                      (n.embeds.push(o), l.log("Added id " + o + "to Add list")))
                : o &&
                  ((t = n.embeds.indexOf(o)) > -1
                    ? (n.embeds.splice(t, 1), l.log("Removed id " + o + " from Add list"))
                    : -1 == (t = n.removeEmbeds.indexOf(o)) &&
                      (n.removeEmbeds.push(o), l.log("Added id " + o + " to Removal list"))),
                (d = 0),
                (n.removeEmbeds.length > n.removeEmbedsLimit || n.embeds.length > 0) &&
              ...
              if (e.length > 0) {
                ...
                e.find(".df-element").each(function () {
                  ...
                  "true" === e.attr("skip-parse") &&
                    (t < n.defaults.loadMoreCount && e.removeAttr("skip-parse"), t++);
                }),
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  this.stageDOM &&
                    (this.stageDOM.removeEventListener("mousemove", this.events.mousemove, !1),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  var r = o.viewPorts[a],
                    ...
                    h = null;
                  if (
                    ((h = s === n.TEXTURE_TARGET.THUMB ? i.thumbSize : Math.floor(l.height)),
                    ...
                    return (
                      d > 0.001 &&
                        d < 2 &&
                        ((p.width = Math.floor(l.width)), (p.height = Math.floor(l.height))),
              ...
              { key: "reset", value: function () {} },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (t.x = t.x - this.app.viewerContainer[0].getBoundingClientRect().left),
              ...
              { key: "onScroll", value: function (e) {} },
              {
                ...
                value: function (e) {
                  var t = this.app,
                    ...
                    o = !0 === e.ctrlKey,
                    a =
                      t.options.mouseScrollAction === n.MOUSE_SCROLL_ACTIONS.ZOOM &&
                  ...
                  o || a
                    ? (i > 0 || i < 0) &&
                      ...
                      t.zoom(i),
                      t.ui.update())
                    : t.options.mouseScrollAction === n.MOUSE_SCROLL_ACTIONS.NAV &&
              ...
              },
              {
                ...
                value: function () {
                  return (
                    (this.visiblePagesCache = []), { main: this.visiblePagesCache, buffer: [] }
                  );
                },
              },
              {
                  ...
                  if (void 0 !== i)
                    return (
                      void 0 === i.annotationElement &&
                        ((i.annotationElement = jQuery("<div class='df-link-content'>")),
                  ...
                  if (void 0 !== i)
                    return (
                      void 0 === i.textElement &&
                        ((i.textElement = jQuery("<div class='df-text-content'>")),
              ...
              { key: "afterControlUpdate", value: function () {} },
              {
                key: "searchPage",
                value: function (e) {
                  return { include: !0, label: this.app.provider.getLabelforPage(e) };
                },
              },
            ]),
            (function (e, t) {
          ...
          return (
            y(n, [
              ...
              },
              {
                key: "resetCSS",
                value: function () {
                  this.element.css({ transform: "", boxShadow: "", display: "block" });
                },
              },
            ]),
            n
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    return (
                      this.textureStamp !== i &&
                      (P.log(
                        "Page " + e + " : texture changed from - " + this.textureStamp + " to " + i
                      ),
                      (this.textureLoaded = !1),
                      (this.textureStamp = i),
          ...
          return (
            (i = [
                  ...
                  if ("-1" !== e.textureStamp && void 0 !== e.pageNumber) {
                    for (
                      ...
                      Math.abs(this.app.currentPageNumber - a) >
                        Math.abs(this.app.currentPageNumber - i) && ((i = a), (n = o));
                    }
                ...
                value: function () {
                  ...
                  return (
                    this.app.pageScaling === n.PAGE_SCALE.PAGE_WIDTH
                      ...
                      ? (o = 1.5 * t.height)
                      : this.app.pageScaling === n.PAGE_SCALE.ACTUAL && (o = 1 * t.height),
                    (o -= 2),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !0 === e.pendingZoom && null != e.zoomDelta
                    ? (i = e.zoomDelta > 0 ? i * e.options.zoomRatio : i / e.options.zoomRatio)
                    : null != this.lastScale && ((i *= this.lastScale), (this.lastScale = null)),
                ...
                value: function () {
                  ...
                  for (
                    var n = this.getVisiblePages().main[0] - 1,
                      o = (n = this.pages[n].element[0]).getBoundingClientRect(),
                  ...
                  if (
                    ...
                    (c += ((p - 1) * 10) / 2),
                      (d += ((p - 1) * 10) / 2),
                      (this.zoomCenter =
                        null !== (u = this.zoomCenter) && void 0 !== u ? u : { x: 0, y: 0 }),
              ...
              },
              {
                ...
                value: function () {
                  for (
                    ...
                    (o = this.pages[a - 1]),
                      a !== o.pageNumber &&
                        (o.resetTexture(), (this.app.textureRequestStatus = n.REQUEST_STATUS.ON)),
              ...
              },
              {
                ...
                value: function (e) {
                  for (
                    var t = this.element[0].scrollTop + this.app.dimensions.containerHeight / 2,
          ...
          function i(e, o) {
            ...
            return (
              ...
              (a.app.options.pageSize === n.FLIPBOOK_PAGE_SIZE.AUTO ||
                a.app.options.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL) &&
          ...
          return (
            N(i, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.app.pageCount < 3) this.pageMode = n.FLIPBOOK_PAGE_MODE.SINGLE;
                      ...
                      if (
                        ...
                        var i = this._calculateInnerHeight(!0),
                          ...
                          a =
                            ...
                            (!0 != e.options.sideMenuOverlay && e.isSideMenuOpen ? 220 : 0);
                        (this.pageMode =
                          i > 1.1 * o && a < 768
                            ? n.FLIPBOOK_PAGE_MODE.SINGLE
                            : n.FLIPBOOK_PAGE_MODE.DOUBLE),
                    ...
                    this.pageMode != t &&
                      this.setPageMode({ isSingle: this.pageMode == n.FLIPBOOK_PAGE_MODE.SINGLE });
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.pageSize === n.FLIPBOOK_PAGE_SIZE.AUTO &&
                    (e._page2Ratio && e._page2Ratio > 1.5 * e.defaultPage.pageRatio
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    this.app.provider.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL &&
                      e > 2 &&
                      (e = 2 * e - 1),
                    this.app.provider.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK &&
                      e > 2 &&
                      (e = 2 * e - 1),
                    e
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  return this.app.provider.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL &&
                    e > 2
                    ? Math.ceil((e - 1) / 2) + 1
                    : this.app.provider.pageSize === n.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK && e > 1
                ...
                value: function (e) {
                  ...
                  return (
                    (this.isDoubleCoverBack() || this.isDoubleInternalPage(e)) &&
                      (this.app.isRTL ? e % 2 == 0 && (t = !0) : e % 2 == 1 && (t = !0)),
                    t
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    0 === e ||
                    (t && 1 === e) ||
                    e === Math.ceil(this.app.pageCount / (t ? 1 : 2)) - (t ? 0 : 1)
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, i) {
                  e > t
                    ? ((this.sheets[i - 1].skipFlip = !0), this.sheets.unshift(this.sheets.pop()))
                    : e < t &&
                      ((this.sheets[0].skipFlip = !0), this.sheets.push(this.sheets.shift()));
                },
              },
              {
                key: "checkSwipe",
                value: function (e, t) {
                  if (
                    ...
                    var i =
                      "vertical" == this.orientation ? e.y - this.lastPosY : e.x - this.lastPosX;
                ...
                value: function () {
                  ...
                  (e =
                    ...
                    this.centerNeedsUpdate &&
                      ((this.centerShift = e), this.updateCenter(t), (this.centerNeedsUpdate = !1));
                },
              },
              {
                key: "updateCenter",
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app;
                  e.dimensions;
                  var t = this.getLeftPageTextureSize({ zoom: !1, isAnnotation: !0 }),
                    i = this.getRightPageTextureSize({ zoom: !1, isAnnotation: !0 });
                  this.maxZoom,
                    e.zoomValue,
                    (this.pureMaxZoom =
                      e.dimensions.maxTextureSize / Math.max(t.height, t.width, i.height, i.width));
                  ...
                  n < this.minZoom && (n = this.maxZoom = this.minZoom),
                    !0 === e.pendingZoom && null != e.zoomDelta
                      ? (o = e.zoomDelta > 0 ? o * e.options.zoomRatio : o / e.options.zoomRatio)
                      : null != this.lastScale && ((o *= this.lastScale), (this.lastScale = null)),
                  ...
                  for (r = 0; r < t; r++) {
                    ...
                    if ((i && (d = h - d - 1), null != (c = this.sheets[r]))) {
                      ...
                      !f && g && c.isFlipping && c.currentTween && c.currentTween.stop(),
                        ...
                        g &&
                          (c.resetTexture(),
                          ((this.app.isRTL ? c.backPage : c.frontPage).pageNumber = this.isBooklet
                            ? d
                            : 2 * d + 1),
                          ((this.app.isRTL ? c.frontPage : c.backPage).pageNumber = this.isBooklet
                            ? -1
                            : 2 * d + 2),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (i = i || (t.currentPageNumber < e && t.oldPageNumber < t.currentPageNumber)) ||
                    (t.currentPageNumber > e && t.oldPageNumber > t.currentPageNumber)
                  );
                },
              },
              {
              ...
              },
              {
                key: "getBasePage",
                value: function (e) {
                  return (void 0 === e && (e = this.app.currentPageNumber), this.isBooklet)
                    ? e
                    : 2 * Math.floor(e / 2);
                },
              },
              ...
              },
              {
                key: "mouseWheel",
                value: function (e) {
                  this.app.options.mouseScrollAction === n.MOUSE_SCROLL_ACTIONS.ZOOM
                  ...
                  return (
                    (o =
                      this.app.zoomValue > 1 || !0 === n
                        ...
                        : I(_(i.prototype), "getAnnotationElement", this).call(this, e, t)) &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.app.zoomValue > 1 || !0 === n
                    ...
                    : I(_(i.prototype), "getTextElement", this).call(this, e, t);
                },
              },
              {
                key: "enterZoom",
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (this.pageMode = i ? n.FLIPBOOK_PAGE_MODE.SINGLE : n.FLIPBOOK_PAGE_MODE.DOUBLE),
                    ...
                    t.viewer.pageMode === n.FLIPBOOK_PAGE_MODE.DOUBLE && t.ui.controls.pageMode
              ...
              },
              {
                ...
                value: function () {
                  this.app.pageCount < 3 && (this.pageMode = n.FLIPBOOK_PAGE_MODE.SINGLE),
                    ...
                    (this.isBooklet =
                      this.isSingle && this.singlePageMode === n.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET),
              ...
              },
              {
                ...
                value: function (e, t, i) {
                  this.isDoublePageFix(i) &&
                    (e.transform[4] =
                      e.transform[4] - Math.floor(Math.min(t.width, 2 * e.width - t.width))),
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app.dimensions,
                    ...
                    a = (this.fullWidth =
                      o * (this.app.viewer.pageMode === n.FLIPBOOK_PAGE_MODE.SINGLE ? 1 : 2)),
                ...
                value: function () {
                  ...
                  if (e.zoomChanged) {
                    ...
                    if (1 === e.zoomValue) (this.left = 0), (this.top = 0);
                      ...
                      (this.left *= i),
                        (this.top *= i),
                        e.viewer.zoomCenter || (e.viewer.zoomCenter = { x: t.x, y: t.y });
              ...
              },
              {
                ...
                value: function () {
                  if (
                    ...
                    (1 !== this.app.zoomValue && this.app.viewer.updatePendingStatusClass(!1),
                    !1 === this.app.options.flipbookFitPages)
                  ) {
                    var e = this.app.viewer.getBasePage(),
                      t = (this.leftViewPort = this.app.viewer.getViewPort(
                        e + (this.app.viewer.isBooklet ? 0 : this.app.viewer.isRTL ? 1 : 0)
                      )),
                      i = (this.rightViewPort = this.app.viewer.getViewPort(
                        e + (this.app.viewer.isBooklet ? 0 : this.app.viewer.isRTL ? 0 : 1)
                      ));
                    if (t) {
                      var n = F.contain(
                        t.width,
          ...
          return (
            N(e, [
              ...
              { key: "flip", value: function () {} },
              {
                key: "frontImage",
                value: function (e) {
                  this.frontPage.loadTexture({ texture: e.texture, callback: e.callback });
                },
              },
              {
                key: "backImage",
                value: function (e) {
                  this.backPage.loadTexture({ texture: e.texture, callback: e.callback });
                },
              },
              {
                key: "resetTexture",
            ...
            j(i, [
              {
                ...
                value: function () {
                  ...
                  var o = (this.wrapper = jQuery(e, { class: "df-sheet-wrapper" })),
                    a = (this.foldInnerShadow = jQuery(e, { class: "df-sheet-fold-inner-shadow" })),
                    s = (this.foldOuterShadow = jQuery(e, { class: "df-sheet-fold-outer-shadow" }));
                ...
                value: function (e, t, i) {
                  (e = Math.floor(e)),
                    ...
                    (this.wrapper[0].style.height = this.wrapper[0].style.width =
                      Math.ceil(Q.distOrigin(e, t) * this.viewer.app.zoomValue) + "px"),
                ...
                value: function (e) {
                  ...
                  if (((e = e || t.pendingPoint), null != t && null != t.viewer)) {
                    ...
                    var i,
                      ...
                      r = t.viewer.isRTL,
                      l =
                        t.viewer.corner === n.TURN_CORNER.BL || t.viewer.corner === n.TURN_CORNER.BR
                          ? t.element.height()
                          : 0,
                    ...
                    !0 === t.isHard
                      ? (null != e && (u = Q.angleByDistance(e.distance, e.fullWidth)),
                      ...
                      : ((i = t.init = { x: e.x, y: e.y, opacity: 1 }),
                        (p =
                          (t.viewer.app.options.duration * Q.distPoints(i.x, i.y, o.x, o.y)) /
                          t.viewer.fullWidth),
                ...
                value: function (e) {
                  if (null != e) {
                    ...
                    var h = t - e.rx / 2,
                      ...
                      x = Q.limitAt(((this.viewer.leftSheetWidth + t - e.rx) * 0.5) / t, 0.05, 0.3);
                    ...
                    this.wrapper.css({ transform: Q.translateStr(b, w) + Q.rotateStr(v) }),
                      k.css({ transform: Q.rotateStr(-v) + Q.translateStr(-b, -w) }),
                      T.css({
                ...
                value: function (e, t) {
                  ...
                  this.wrapper.css({
                    ...
                    this.backPage.updateCSS({
                      ...
                      transform:
                        ("MfS" !== Q.prefix.dom ? "" : "perspective(" + i + "px) ") +
                        (!0 === t ? "translateX(-100%) " : "") +
                        "rotateY(" +
                        ((!0 === t ? 180 : 0) + e) +
                        "deg)",
                    ...
                    this.frontPage.updateCSS({
                      display: !0 === t ? (e > -90 ? "block" : "none") : e >= 90 ? "block" : "none",
                      transform:
                        ("MSd" !== Q.prefix.dom ? "" : "perspective(" + i + "px) ") +
                        (!1 === t ? "translateX(100%) " : "") +
                        "rotateY(" +
                        ((!1 === t ? -180 : 0) + e) +
                        "deg)",
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  !0 === this.isHard
                    ...
                    : (this.updatePoint({ x: e.x, y: e.y }), (this.x = e.x), (this.y = e.y)),
                    t &&
                      !a &&
        ...
        Y = /*#__PURE__*/ (function (e) {
          ...
          function i(e, o) {
            ...
            return (
              ...
              ((a = t.call(this, e, o)).bookShadow = jQuery("<div>", { class: "df-book-shadow" })),
                ...
                value: function () {
                  var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    t =
                      (this.centerShift *
                        (this.isRTL,
                        this.isLeftPage() ? this.leftSheetWidth : this.rightSheetWidth)) /
                      2;
                  (this.seamPosition =
                    (-this.app.dimensions.offset.width + this.app.dimensions.containerWidth) / 2 +
                    t),
                    (this.wrapperShift =
                      (this.isSingle ? -this.app.dimensions.stage.innerWidth / 2 : 0) + t),
                  ...
                  !1 === t.isFlipping &&
                    (e.needsFlip
                      ...
                      : ((t.skipFlip = !1),
                        ...
                        t.element.addClass(
                          t.targetSide === n.TURN_DIRECTION.LEFT ? "df-left-side" : "df-right-side"
                        ),
                        (t.side = t.targetSide),
                    ...
                    t.updateCSS({ display: !0 === t.visible ? "block" : "none", zIndex: e.zIndex }),
                ...
                value: function (e) {
                  ...
                  return (
                        ...
                        : n.TURN_CORNER.NONE),
                    {
                      ...
                      isInsideCorner:
                        v !== n.TURN_CORNER.NONE && v !== n.TURN_CORNER.L && v !== n.TURN_CORNER.R,
                      x: c ? f.x : a,
                      y: c ? f.y : s,
                      fullWidth: i,
                      sheetWidth: t,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    null != this.dragSheet ||
                      ((t.y = Q.limitAt(t.y, 1, this.availablePageHeight() - 1)),
                  ...
                  if (null != this.startPoint && (e.touches || 0 === e.button)) {
                    ...
                    if (!0 === e.ctrlKey && o) this.zoomOnPoint(t);
                      ...
                      if (
                        ...
                        o &&
                          (!0 === t.isInsideCorner ||
                            (t.isInsideSheet && this.clickAction === n.MOUSE_CLICK_ACTIONS.NAV)))
                      )
                        ...
                        t.distance > t.sheetWidth / 2 &&
                          (t.sheet.side === n.TURN_DIRECTION.LEFT
                            ? this.app.openLeft()
                            : this.app.openRight()),
                          s === this.getBasePage() && ((a.animateToReset = !0), a.flip(t));
                      }
                      ...
                      o &&
                        ...
                        ("left" === t.sheet.side ? this.app.openLeft() : this.app.openRight());
                    (this.startPoint = null),
                      (this.canSwipe = !1),
                      (this.drag = n.TURN_DIRECTION.NONE);
                  }
                      ...
                      t.isInsideCorner && null == this.flipPage
                        ? ((this.dragSheet = t.sheet),
                          ...
                          0 === t.sheet.pageNumber
                            ...
                            : t.sheet.pageNumber === Math.ceil(this.app.pageCount / 2) - 1 &&
                              this.bookShadow.css({
                                width: "50%",
            ...
            ee(i, [
              {
                key: "init",
                value: function () {
                  var e = (this.element = jQuery("<div>", { class: "df-sheet" }));
              ...
              },
              {
                ...
                value: function (e, t, i) {
                  (e = Math.floor(e)),
                    (t = Math.floor(t)),
                    (i = Math.floor(i)),
                    (this.element[0].style.height = this.frontPage.element[0].style.height =
                      t + "px"),
                    (this.element[0].style.width = this.frontPage.element[0].style.width =
                      e + "px"),
                    (this.element[0].style.transform =
                      "translateX(" + this.positionX + "px) translateY(" + i + "px)");
                },
              },
            ]),
            i
            ...
            ee(i, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  t.element.toggleClass("df-no-transition", t.skipFlip || this.skipTransition),
                    ...
                    t.updateCSS({
                      display:
                        e.sheetNumber > 0 && e.sheetNumber <= this.app.pageCount ? "block" : "none",
                      zIndex: e.zIndex,
                    }),
                    i !== t.pageNumber &&
                      (t.element.attr("number", i),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (t.isInsideSheet = jQuery(e.srcElement).closest(".df-page").length > 0),
                    (t.isInsideCorner = !1),
                    t
                  );
                },
                    ...
                    for (var s = 0; s < this.stackCount; s++) {
                      ...
                      if (this.getPageByNumber(r)) {
                        ...
                        i.currentPageNumber === l.pageNumber &&
                          (this.leftSheetWidth = this.rightSheetWidth = Math.floor(u.width)),
                          i.currentPageNumber > l.pageNumber
                            ? ((e -= Math.floor(u.width) + 10), (l.positionX = e))
                            : ((l.positionX = t), (t += Math.floor(u.width) + 10));
          ...
          (ey = {
              ...
              if ((e.parent.remove(e), (e = l.disposeObject(e)), null != i)) {
                if (null == i.length)
                  i.map && ((t = i.map), i.dispose(), t.dispose()),
                    ...
                    i.normalMap && ((t = i.normalMap), i.dispose(), t.dispose());
                else
                  for (var n = 0; n < i.length; n++)
                    i[n] &&
                      (i[n].map && ((t = i[n].map), i[n].dispose(), t.dispose()),
                      i[n].bumpMap && ((t = i[n].bumpMap), i[n].dispose(), t.dispose()),
                      i[n].normalMap && ((t = i[n].normalMap), i[n].dispose(), t.dispose())),
                      (i[n] = null);
                (i = null), (t = null);
              }
            },
                  ...
                  ? (r =
                      null == i
                        ...
                        : ey.textureLoader.load(
                            ...
                            function () {
                              null == r.image &&
                                ey.loadImage(t, ey.defaults.textureLoadFallback, n, o),
                                ey.loadTextureFailed();
                            }
                          )) && (r.mapping = e.UVMapping)
                  : (ey.loadTexture(null, t, o, n), "function" == typeof a && a(t, r)),
                0
              );
            },
            loadTexture: function (t, i, n, o) {
              ...
              null !== t &&
                ...
                !0 === e.skipPowerOfTwo &&
                  ((t.minFilter = e.LinearFilter), (t.magFilter = e.LinearFilter)),
                ...
                value: function () {
                  if (void 0 !== this.viewer && null !== this.viewer) {
                    var e = !0 === this.isHard ? 0 : this.flexibility,
                      t =
                        ("vertical" === this.viewer.orientation ? this.height : this.width) *
                        (1 - Math.sin((e / 2) * (e / 2)) / 2 - e / 20);
                    this.element.scale.y =
                      ("vertical" === this.viewer.orientation ? this.width : this.height) /
                    ...
                    "vertical" !== this.viewer.orientation &&
                      (this.element.position.x = -Math.cos(f) * this.viewer.pageOffset),
                      "vertical" === this.viewer.orientation &&
                        (this.element.position.y = Math.cos(f) * this.viewer.pageOffset);
                    var g = !0 === this.isHard ? f : (this.curveAngle * Math.PI) / 180,
                      v = (this.sheetAngle * Math.PI) / 180,
                      m = v - Math.PI / 2,
                      y = (Math.sin(m) * p) / 2;
                    (h[0][0] = h[0][1] =
                      new THREE.Vector3(-n * Math.cos(f), 0, Math.sin(f) * n - y)),
                      (u[0][0] = u[0][1] =
                        new THREE.Vector3(h[0][0].x - Math.cos(m) * p, 0, h[0][0].z + 2 * y)),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  (i.init = {
                    ...
                    (i.first = { angle: e + o / 4, index: (a && !s) || (!a && s) ? 1 : 0.25 }),
                    (i.mid = { angle: e + (2 * o) / 4, index: 0.5 }),
                    (i.mid2 = { angle: e + (3 * o) / 4, index: (a && !s) || (!a && s) ? 0.25 : 1 }),
                    (i.end = {
                      angle: t,
                      index: (a && !s) || (!a && s) ? 0 : 1,
                  ...
                  var p = function (e) {
                    (i.sheetAngle = e.angle),
                      ...
                      !0 === i.isHard
                        ? ((i.flexibility = 0), i.isCover && i.viewer.flipCover(i))
                        : (i.flexibility = e.angle < 90 ? i.leftFlexibility : i.rightFlexibility),
                      (i.element.position.z = (e.angle < 90 ? i.leftPos : i.rightPos) + i.depth),
                      n &&
                        ((i.element.material[5].opacity = i.element.material[4].opacity = e.index),
                  ...
                  n &&
                    ((!a && !s) || (a && s)) &&
                    ((i.element.material[5].opacity = i.element.material[4].opacity = 0),
        ...
        eL = /*#__PURE__*/ (function (e) {
          ...
          function i(e, n) {
            ...
            return (
              ...
              (o.texturePowerOfTwo =
                !eO.isMobile && (null === (r = e.texturePowerOfTwo) || void 0 === r || r)),
              (o.color3DSheets =
                null !== (l = o.app.options.color3DSheets) && void 0 !== l ? l : "white"),
              (o.midPosition = 0),
            ...
            eS(i, [
                ...
                value: function (e) {
                  ...
                  "undefined" == typeof THREE
                    ? (t.updateInfo(t.options.text.loading + " WEBGL 3D ..."),
                      "function" == typeof window.define && window.define.amd && window.requirejs
                        ? (window.requirejs.config({
                            paths: { three: t.options.threejsSrc.replace(".js", "") },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.sheetDepth =
                    this.pageScaleX *
                    (null !== (e = this.app.options.sheetDepth) && void 0 !== e ? e : 0.5)),
                    (this.sheetSegments =
                      null !== (t = this.app.options.sheetSegments) && void 0 !== t ? t : 20),
              ...
              },
              {
                key: "initStage",
                value: function () {
                  var e = (this.stage = new ey.Stage({ pixelRatio: this.app.options.pixelRatio }));
                  (e.canvas = jQuery(e.renderer.domElement).addClass("df-3dcanvas")).appendTo(
                    this.element
                  ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.coverExtraWidth = ("vertical" == e.orientation ? 2 : 1) * r * 0.025),
                    (this.coverExtraHeight = ("vertical" == e.orientation ? 1 : 2) * r * 0.025),
                    !0 !== this.has3DCover &&
              ...
              },
              {
                ...
                value: function (e, t, i, n) {
                  ...
                  (e.far = 3 * c),
                    ...
                    void 0 !== n &&
                      ((n.target = new THREE.Vector3(0, 0, 0)), (n.maxDistance = 2 * c));
                },
              },
                ...
                value: function () {
                  ...
                  if (l) {
                    (this.leftSheets.depth = p
                      ? this.sheetsDepth * (1 - this.getBasePage() / e.pageCount)
                      ...
                      (h -=
                        this.coverDepth +
                        (this.leftSheets.element.visible ? this.leftSheets.depth / 2 : 0) +
                        3 * this.coverDepth),
                    ...
                    g && (v = this.leftSheetHeight),
                      ...
                      (u -=
                        this.coverDepth +
                        (this.rightSheets.element.visible ? this.rightSheets.depth / 2 : 0) +
                        3 * this.coverDepth),
                      !0 !== this.rightCover.isFlipping &&
                      ...
                      (this.stage.ground.position.z =
                        Math.min(h, u) - (this.refSize * this.groundDistance) / 100),
                      ...
                      0 !== e.options.flipbook3DTiltAngleLeft
                        ? ((t.camera.aspect = i.stage.width / i.stage.height),
                          ...
                          this.bookWrapper.rotateZ(
                            THREE.Math.degToRad(-e.options.flipbook3DTiltAngleLeft)
                          ),
                          this.bookWrapper.rotateX(
                            THREE.Math.degToRad(-e.options.flipbook3DTiltAngleUp)
                          ),
                          "vertical" == this.orientation
                            ? (this.bookWrapper.scale.y = 1 / (this.isSingle ? 2 : 1))
                            : (this.bookWrapper.scale.x = 1 / (this.isSingle ? 2 : 1)),
                ...
                value: function (e) {
                  ...
                  (i.leftFlexibility = s ? this.leftFlexibility : 0),
                    ...
                    (i.leftPos =
                      ...
                      this.sheetDepth / 2),
                    (i.rightPos =
                      this.midPosition - (o - e.midPoint) * this.sheetDepth - this.sheetDepth / 2),
                      ...
                      (e.needsFlip
                        ? ((i.isFlipping = !0),
                          ...
                          (i.element.position.z =
                            Math.max(a < 90 ? i.leftPos : i.rightPos, this.midPosition) +
                            this.sheetDepth),
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = this.app,
                    i =
                      "vertical" == this.orientation ? e.wrapper.position.y : e.wrapper.position.x,
                    o =
                      ...
                      2;
                  (e.seamPosition =
                    (-t.dimensions.offset.width + t.dimensions.containerWidth) / 2 + o),
                    o !== e.centerEnd &&
                ...
                value: function (e) {
                  "vertical" == this.orientation
                    ? ((this.wrapper.position.y = e.x),
                      this.stage && this.stage.cssScene && (this.stage.cssScene.position.y = e.x))
                  ...
                  0 === e.pageNumber || (this.isBooklet && 1 === e.pageNumber)
                    ...
                    null !== n &&
                      ...
                      (n.element.position.x =
                        e.element.position.x + t * Math.sin((e.sheetAngle * Math.PI) / 180) * i),
                      (n.element.position.z =
                        e.element.position.z + t * Math.cos((e.sheetAngle * Math.PI) / 180) * i));
                },
              },
              {
                key: "pagesReady",
                  ...
                  if (!this.isAnimating() && !0 === this.refreshRequested) {
                    if (!1 === this.app.options.flipbookFitPages) {
                      ...
                      for (var s = 0; s < this.sheets.length; s++) {
                        var r = this.sheets[s];
                        r.side === n.TURN_DIRECTION.LEFT
                          ? ((r.height = this.leftSheetHeight), (r.width = this.leftSheetWidth))
                          : ((r.height = this.rightSheetHeight), (r.width = this.rightSheetWidth)),
                          r.updateAngle();
                      }
                  ...
                  if (!0 !== this.isClosedPage()) {
                    ...
                    if (
                      ...
                      var i = this.rightSheets.element.geometry.attributes.position,
                        n = e
                          ? t.sheet.element.geometry.boundingBox.max.x * t.sheet.element.scale.x
                    ...
                    if (
                      ...
                      var a = this.leftSheets.element.geometry.attributes.position,
                        s = e
                          ? o.sheet.element.geometry.boundingBox.min.x * o.sheet.element.scale.x
              ...
              { key: "updateCSSLayer", value: function () {} },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    !0 !== this.isDragging &&
                      (this.updatePendingStatusClass(!0), (this.isDragging = !0));
                    ...
                    if (1 === this.app.zoomValue) {
                      ...
                      !0 === e.ctrlKey && a
                        ...
                        : a &&
                          t.sheet &&
                          this.clickAction === n.MOUSE_CLICK_ACTIONS.NAV &&
                          (t.sheet.sheetAngle > 90 ? this.app.openRight() : this.app.openLeft());
                    }
                    (this.dragSheet = null),
                      (this.drag = null),
                  ...
                  if ((e = eO.fixMouseEvent(e)).touches || 0 === e.button) {
                    if (null != e.touches && 2 === e.touches.length) this.pinchDown(e);
                      ...
                      var i = this.raycastCLick(e),
                        o = t.sheet
                          ? t.sheet.width -
                            Math.abs(t.x - (this.app.dimensions.origin.x + this.centerEnd))
                          : 0;
      ...
      (g.prototype.pinchDown = function (e) {
        null != e.touches &&
          ...
          ((this.startTouches = ez.getTouches(e)),
          (this.app.viewer.zoomCenter = ez.getVectorAvg(
            ez.getTouches(e, this.parentElement.offset())
          )),
          (this.lastScale = 1));
      }),
        ...
        (g.prototype.pinchMove = function (e) {
          if (null != e.touches && 2 == e.touches.length && null != this.startTouches) {
            ...
            this.lastScale,
              (this.lastScale = t),
              (this.app.viewer.pinchZoomUpdateScale = ez.limitAt(
                t,
              ...
              this.app.viewer._pinchZoomLastScale != this.app.viewer.pinchZoomUpdateScale &&
                ((this.app.viewer.pinchZoomRequestStatus = n.REQUEST_STATUS.ON),
                (this.app.viewer._pinchZoomLastScale = this.app.viewer.pinchZoomUpdateScale)),
              e.preventDefault();
            return;
          }
        ...
        (eL.prototype.set3DCoverNormal = function () {
          ...
          if (e !== n.FLIPBOOK_COVER_TYPE.PLAIN) {
            ...
            (s.fillStyle = o),
              ...
              s.fill(),
              i &&
                ((t = s.createLinearGradient(1.92, 0, 7.68, 0)).addColorStop(0, "rgb(127,127,255)"),
            ...
            (l.fillStyle = o),
              ...
              l.fill(),
              i &&
                ((t = l.createLinearGradient(120.32, 0, 126.08, 0)).addColorStop(
                  0,
                  "rgb(127,127,255)"
                ),
        ...
        (eL.prototype.setcolor3DCover = function () {
          ...
          if (
            ...
            s.strokeRect(0.1 * o, 0.05 * o, o * (this.hasSpiral ? 0.9 : 0.85), 0.9 * o),
            s.beginPath(),
          ...
          if (!0 === this.hasSpiral) {
            ...
            (t /= 1e3),
              (this.leftHoles.position.z = this.rightHoles.position.z =
                e + 2 / t + (this.isClosedPage() ? 2 * this.leftCover.depth : 0) / t),
                ...
                value: function () {
                  arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    !0 !== this.isAnimating() &&
                      (this.pagesReady(),
                      this.updatePendingStatusClass(),
                      this.updateZoomViewerTexture({ pageNumber: this.getBasePage() }),
                      this.updateZoomViewerTexture({ pageNumber: this.getBasePage() + 1 }));
                },
              },
              {
                key: "exchangeTexture",
                value: function (e, t) {
                  (this.skipCenterAnimation = !0),
                    ...
                    this.updateZoomViewerTextContent({ pageNumber: this.getBasePage() }),
                    this.updateZoomViewerTextContent({ pageNumber: this.getBasePage() + 1 });
                },
              },
              {
                ...
                value: function (e) {
                  var t,
                    ...
                    o = function (t) {
                      ...
                      a
                        ? ((a = n.pdfApp.viewer.getViewerPageNumber(a)) > n.pdfApp.pageCount &&
                            (a = n.pdfApp.pageCount),
                          eQ.log("Loading for:", t, " at page ", a),
                          n.pdfApp.requestDestRefKey === t.num + " " + t.gen + " R"
                            ? (n.pdfApp.gotoPage(a),
                              n.pdfHistory && n.pdfHistory.push({ dest: e, hash: i, page: a }))
                  ...
                  "string" == typeof e
                    ...
                    t.then(function (t) {
                      eQ.log("Started:", t),
                        (e = t),
                        eq(t, Array) &&
                          ((n.pdfApp.requestDestRefKey = t[0].num + " " + t[0].gen + " R"),
                          o(t[0]));
                    });
                },
              },
                  ...
                  if ("" !== e && null != e && "null" !== e) {
                    ...
                    if (isNaN(Math.floor(e))) {
                      if ("string" == typeof e && isNaN((t = parseInt(e.replace("#", ""), 10)))) {
                        window.open(
                          e,
                          this.pdfApp.options.linkTarget === n.LINK_TARGET.SELF ? "_self" : "_blank"
                        );
                        return;
                      }
                    } else t = e;
          ...
          return (
            eW(e, [
              ...
              { key: "softDispose", value: function () {} },
              {
                ...
                value: function (e, t, i) {
                  i &&
                    (void 0 === this.textureCache[i] && (this.textureCache[i] = []),
                ...
                value: function () {
                  this.finalizeOutLine(),
                    this.app &&
                      ...
                      eQ.log("Provider needs to initialize page properties for the app"),
              ...
              l = function (e) {
                ...
                (t.href = h.options.pdfjsWorkerSrc + u.cacheBustParameters),
                  t.hostname !== window.location.hostname && !0 === n.loadCorsPdfjsWorker
                    ? (h.updateInfo(h.options.text.loading + " PDF Worker CORS ..."),
                      jQuery.ajax({
                  ...
                  eQ.getScript(
                    ...
                    function () {
                      ...
                      window.require.config
                        ? (h.updateInfo(h.options.text.loading + " PDF Service (require) ..."),
                          window.require.config({
                            paths: {
                              "pdfjs-dist/build/pdf.worker": h.options.pdfjsWorkerSrc.replace(
                                ".js",
                                ""
                              ),
                            },
                ...
                value: function () {
                  ...
                  o._worker.promise.then(function (t) {
                    ...
                    o.promise
                          ...
                          n.getPage(1).then(function (o) {
                            ...
                            (i.viewPorts[1] = s),
                              ...
                              (e.dimensions.maxTextureHeight =
                                (null !== (a = t.maxTextureSize) && void 0 !== a ? a : 3200) /
                                (r > 1 ? r : 1)),
                      ...
                      .catch(function (t) {
                        if (null !== e && null != e.options) {
                          ...
                          var s =
                            (null === (n = e.options) || void 0 === n ? void 0 : n.fileName) ||
                            a.href;
                          e.updateInfo(
                            o +
                    ...
                    (o.getTotalLength = function () {
                      return i.pdfLoadProgress._transport._networkStream._fullRequestReader
                        .contentLength;
                    }),
                    (o.onProgress = function (t) {
                      if (null !== e) {
                        ...
                        isNaN(i)
                          ? t && t.loaded
                            ? (void 0 === o.lastLoaded || o.lastLoaded + 25e4 < t.loaded) &&
                          ...
                          : e.updateInfo(
                              e.options.text.loading +
                                " PDF " +
                                Math.ceil(Math.min(100, i)).toString().split(".")[0] +
                                "% ..."
                            );
                      }
                    });
                ...
                value: function () {
                  ...
                  t.pdfDocument
                    ...
                    .then(function (i) {
                      null !== i &&
                        Array.isArray(i) &&
                        ((t.canPrint = i.indexOf(pdfjsLib.PermissionFlag.PRINT) > -1),
                        !1 == t.canPrint &&
                  ...
                  eQ.log("Requesting PDF Page:" + s),
                    i.pdfDocument
                      ...
                      .then(function (r) {
                        ...
                        e.isFreshPage &&
                          (null === (l = t.viewer.getPageByNumber(e.pageNumber)) ||
                            void 0 === l ||
                            l.changeTexture(e.pageNumber, h.canvas.height)),
                          eQ.log(
                            "Page " + n + " rendering - " + h.canvas.width + "x" + h.canvas.height
                          ),
                          (e.trace = i.requestIndex++),
                          (i.requestedPages +=
                            "," + e.trace + "[" + s + "|" + h.canvas.height + "]"),
                              ...
                              if (
                                ...
                                eQ.log("CleanUp Requesting for (" + n + ") actual " + s),
                                  i.requestedPages.indexOf(l) > -1 &&
                                    ((i.requestedPages = i.requestedPages.replace(l, "")),
                                    -1 == i.requestedPages.indexOf("[" + s + "|")
                                      ? (eQ.log("CleanUp Passed for (" + n + ") actual " + s),
                                        i.pagesToClean.push(r),
                                        i.pagesToClean.length > 0 && i.cleanUpPages())
                                      : eQ.log(
                    ...
                    i
                      ...
                      .then(function (n) {
                        for (var o, a = RegExp(e, "gi"), s = []; (o = a.exec(n)); )
                          s.push({ index: o.index, length: i.textSearchLength });
                          ...
                          !0 === r.include &&
                            ...
                            i.app.searchResults.append(
                              '<div class="df-search-result ' +
                                (i.app.currentPageNumber === t ? "df-active" : "") +
                                '" data-df-page="' +
                                t +
                                '"><span>Page ' +
                                r.label +
                        ...
                        i.app.viewer.isActivePage(t) &&
                          (i.processTextContent(t, i.app.viewer.getTextElement(t, !0)),
                          i.app.ui.update()),
                          i._search(e, t + 1);
                      })
                      .catch(function () {})
                      .finally(function () {
                        0 == i.totalHits
                          ...
                          : i.app.updateSearchInfo(i.totalHits + " results found"),
                  ...
                  if (void 0 == n.textContentJoinedSearch[t] || i) {
                    ...
                    for (var l = 0; l < e.items.length; l++)
                      (o = e.items[l]),
                        ...
                        n.textOffsetSearch[t].push({ length: r, offset: s - r }),
            ...
            e2(e, [
              {
                ...
                value: function () {
                  var e =
                    arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { scale: 1 };
                  return new e7(
                ...
                value: function () {
                  ...
                  i.document.getPage(1).then(function (n) {
                    ...
                    (i.viewPorts[1] = a),
                      ...
                      (e.dimensions.maxTextureHeight =
                        (null !== (o = t.maxTextureSize) && void 0 !== o ? o : 3200) /
                        (s > 1 ? s : 1)),
                ...
                value: function (e) {
                  ...
                  e8.log("Requesting PDF Page:" + a),
                    i.document.getPage(a).then(function (a) {
                      ...
                      (e.isFreshPage &&
                        (null === (s = t.viewer.getPageByNumber(e.pageNumber)) ||
                          void 0 === s ||
                      ...
                      !0 === e.preferCanvas)
                        ? (l.canvas
                            ...
                            .drawImage(
                              ...
                              0,
                              l.canvas.width *
                                (null !== (r = l.viewport.widthFix) && void 0 !== r ? r : 1),
                              l.canvas.height
                            ),
                          t.applyTexture(l.canvas, e))
                        : t.applyTexture(
                            { src: a.src, height: l.canvas.height, width: l.canvas.width },
                            e
                          ),
                        e8.log(
                          "Rendered " + n + " in " + (performance.now() - o) + " milliseconds"
                        );
                    });
                },
              },
      ...
      var to = n.jQuery,
        ...
        tr = /*#__PURE__*/ (function () {
          function e(t, i) {
            te(this, e),
              ...
              (this.leftElement = to("<div>", { class: "df-ui-left" }).appendTo(this.element)),
              (this.centerElement = to("<div>", { class: "df-ui-center" }).appendTo(this.element)),
              (this.rightElement = to("<div>", { class: "df-ui-right" }).appendTo(this.element)),
              this.parentElement.append(this.element),
              (this.events = {}),
              (this.controls = {});
          }
                ...
                value: function () {
                  ...
                  e.createLogo(),
                    ...
                    !0 == i.options.autoPlay &&
                      ((this.play = o.play =
                        ta.createBtn("play", s.play, a.play).on("click", function () {
                          var e = to(this);
                  ...
                  (this.pageInput = o.pageInput =
                    to('<input id="' + r + '" type="text"/>').appendTo(o.pageNumber)),
                    (this.pageLabel = o.pageLabel =
                      to('<label for="' + r + '"></label>').appendTo(o.pageNumber)),
                    (this.thumbnail = o.thumbnail =
                      ta.createBtn("thumbnail", s.thumbnail, a.toggleThumbnails)),
                    o.thumbnail
                      .on("click", function () {
                        var t = to(this);
                        ...
                        .on("click", function () {
                          ...
                          if ((null == i.searchContainer && i.initSearch(), i.searchContainer)) {
                            ...
                            t.toggleClass("df-active"),
                              n.toggleClass("df-sidemenu-visible"),
                              t.hasClass("df-active") &&
                                (t.siblings(".df-active").trigger("click"), i.searchBox.focus()),
                              e.update(),
                              !1 === i.options.sideMenuOverlay && i.resizeRequestStart();
                          }
                        })
                  ...
                  if (
                    ((this.zoomIn = o.zoomIn =
                      ta.createBtn("zoomin", s.zoomin, a.zoomIn).on("click", function () {
                        i.zoom(1), e.update();
                      })),
                    (this.zoomOut = o.zoomOut =
                      ta.createBtn("zoomout", s.zoomout, a.zoomOut).on("click", function () {
                        i.zoom(-1), e.update();
                      })),
                    (this.resetZoom = o.resetZoom =
                      ta.createBtn("resetzoom", s.resetzoom, a.resetZoom).on("click", function () {
                    ...
                    if (i.pageCount > 2) {
                      ...
                      this.pageMode = o.pageMode = ta
                        ...
                        .on("click", function () {
                          var e = to(this);
                          i.viewer.setPageMode({ isSingle: !e.hasClass(s.doublepage) }),
                  ...
                  if (
                    ...
                    (this.share = o.share =
                      ta.createBtn("share", s.share, a.share).on("click", function () {
                        !0 === e.shareBox.isOpen
                          ? e.shareBox.close()
                          : (e.shareBox.update(i.getURLHash()), e.shareBox.show());
                      })),
                    (this.more = o.more =
                    ...
                    (this.startPage = o.startPage =
                      ta.createBtn("start", s.start, a.gotoFirstPage).on("click", function () {
                        i.start();
                      })),
                    (this.endPage = o.endPage =
                      ta.createBtn("end", s.end, a.gotoLastPage).on("click", function () {
                        i.end();
                      })),
                    !0 === i.options.showPrintControl &&
                      ...
                      "string" == typeof i.options.source &&
                      (this.print = o.print =
                        ta.createBtn("print", s.print, a.print).on("click", function () {
                  ...
                  (e.moreContainer = to(t, { class: "df-more-container" })),
                    ...
                    (!0 === i.options.isLightBox && !0 !== i.fullscreenSupported) ||
                      (this.fullScreen = o.fullScreen =
                        ta
                          .createBtn("fullscreen", s.fullscreen, a.toggleFullscreen)
                  ...
                  for (var f = 0; f < p.length; f++) {
                    ...
                    if (0 > d.indexOf("," + g + ",")) {
                      ...
                      null != v &&
                        ...
                        (c.indexOf("," + g + ",") > -1 && "more" !== g && "pageNumber" !== g
                  ...
                  if ("INPUT" !== e.target.nodeName) {
                    ...
                    switch (
                      (t.options.arrowKeysAction === n.ARROW_KEYS_ACTIONS.NAV &&
                        ((!0 === t.isFullscreen || !0 === t.options.isLightBox) && (i = !0),
                ...
                value: function () {
                  ...
                  !0 !== this._pageLabelWidthSet &&
                    ...
                    e.provider.pageLabels
                      ? this.pageLabel.html(
                          "88888888888888888".substring(0, 3 * e.pageCount.toString().length + 4)
                        )
                      : this.pageLabel.html(
                          "88888888888".substring(0, 2 * e.pageCount.toString().length + 3)
                        ),
                  ...
                  i.toString() !== e.currentPageNumber.toString()
                    ? t.pageLabel.html(i + "(" + e.currentPageNumber + "/" + e.pageCount + ")")
                  ...
                  var n =
                    ...
                    e.container.find(".df-sidemenu-visible.df-search-container").length > 0;
                  if ((e.container.toggleClass("df-search-open", n), n)) {
                    var o = e.searchContainer.find(
                      ".df-search-result[data-df-page=" + e.currentPageNumber + "]"
                    );
                    if (
                      (e.searchContainer
                      ...
                      var a = e.searchResults[0],
                        s = a.scrollTop;
                      s + a.getBoundingClientRect().height < (o = o[0]).offsetTop + o.scrollHeight
            ...
            ti(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  i.box
                    .appendTo(i.wrapper)
                    .html('<span class="df-share-title">' + t.text.share + "</span>"),
                  (i.urlInput = to('<textarea name="df-share-url" class="df-share-url">').on(
                    "click",
                    function () {
                      to(this).select();
                    }
                        ...
                        null !== n &&
                          ((i[e] = to("<div>", {
                            ...
                            e.preventDefault(),
                              window.open(
                                n
                                  .replace("{{url}}", encodeURIComponent(i.shareUrl))
          ...
          function e(t) {
            ...
            return (
              ...
              (i.closeButton = to("<div>")
                .addClass("df-lightbox-close df-ui-btn " + n.defaults.icons.close)
                .on("click", function () {
                  i.close(t);
                })
                .appendTo(i.controls)),
        ...
        tu = /*#__PURE__*/ (function () {
          function e() {
            ...
            var t = this;
            return (
              (t.frame = to('<iframe id="df-print-frame" style="display:none">').appendTo(
                to("body")
              )),
        ...
        tp = /*#__PURE__*/ (function () {
          function e(t, i) {
            te(this, e),
              ...
              this.parentElement.append(this.element),
              (this.buttons = to("<div>", { class: "df-sidemenu-buttons df-ui-wrapper" }).appendTo(
                this.element
              )),
            ...
            ti(e, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (
                    var i = e.querySelectorAll("." + this.outlineToggleClass), n = 0, o = i.length;
                    n < o;
                    ++n
                  )
                      ...
                      for (var s = o.shift(), r = s.custom, l = 0, h = s.items.length; l < h; l++) {
                        ...
                        if (
                          ...
                          (d.className = this.outlineItemClass + "s"),
                            p.appendChild(d),
                            o.push({ parent: d, custom: u.custom, items: u.items });
                        }
            ...
            ti(e, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    a.length > 0
                      ? (e.thumbContainer.find(".df-selected").removeClass("df-selected"),
                  ...
                  if (
                    0 === e.thumblist.container.getElementsByClassName("df-thumb-requested").length
                  ) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (e.textureTarget === n.TEXTURE_TARGET.THUMB) {
                    ...
                    a.find(".df-wrapper").css({ height: e.height, width: e.width }),
                      a.find(".df-bg-image").css({ backgroundImage: ta.bgImage(o) }),
      ...
      (n.openLightBox = function (e) {
            ...
            null === n.activeLightBox.app &&
              n.activeLightBox.show(function () {
                (n.activeLightBox.app = to(n.activeLightBox.element).dearviewer({
                  ...
                  n.activeLightBox.lightboxWrapper.toggleClass(
                    "df-rtl",
                    n.activeLightBox.app.options.readDirection === n.READ_DIRECTION.RTL
                  ),
                  n.activeLightBox.backGround.css({
                    backgroundColor:
                      "transparent" === n.activeLightBox.app.options.backgroundColor
        ...
        (n.openURL = function (e) {
          tf(),
            e && ((n.openFileOptions.source = e), (n.openFileOptions.pdfParameters = null)),
            ...
            (!1 !== n.defaults.autoPDFLinktoViewer &&
              e.on("click", 'a[href$=".pdf"]', function (e) {
                ...
                void 0 !== t.attr("download") ||
                  ...
                  (e.preventDefault(), t.data("df-source", t.attr("href")), n.openLightBox(t));
              }),
        ...
        ty = /*#__PURE__*/ (function () {
          ...
          function t(e) {
            ...
            (function (e, t) {
              ...
              tm.isMobile &&
                (e.maxTextureSize = 4096 === e.maxTextureSize ? 3200 : e.maxTextureSize),
              (this.dimensions = {
                padding: {},
                offset: {},
                pageFit: {},
              ...
              (this.isExternalReady =
                null === (a = this.options.isExternalReady) || void 0 === a || a),
              this.init(),
            ...
            (e = [
              {
                ...
                value: function () {
                  ...
                  (this.commentPopup = tg('<div class="df-comment-popup">').appendTo(
                    this.container
                  )),
                    (this.viewer = new this.viewerType(e, this)),
                    (this.sideMenu = new tp({ parentElement: this.container }, this)),
                  ...
                  this.element.addClass("df-app").removeClass("df-container df-loading"),
                    ...
                    this.container.addClass(
                      "df-container df-loading df-init df-controls-" +
                        ...
                        (!0 === this.options.controlsFloating ? " df-float" : " df-float-off") +
                        ("transparent" === this.options.backgroundColor ? " df-transparent" : "") +
                        (!0 === this.isRTL ? " df-rtl" : "") +
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (void 0 !== window[n.locationVar]) {
                    if (
                      ((e.pdfjsSrc = window[n.locationVar] + "js/libs/pdf.min.js"),
                      ...
                      "latest" == e.pdfVersion || "beta" == e.pdfVersion
                        ...
                        ("latest" == e.pdfVersion || "default" == e.pdfVersion) &&
                          (Array.prototype.at,
                        ...
                        "default" !== t &&
                          "" !== t &&
                          ((e.pdfjsSrc =
                            window[n.locationVar] + "js/libs/pdfjs/" + t + "/pdf.min.js"),
                          (e.pdfjsWorkerSrc =
                            window[n.locationVar] + "js/libs/pdfjs/" + t + "/pdf.worker.min.js")),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  clearInterval(this.autoPlayTimer),
                    ...
                    this.events &&
                      (window.removeEventListener("resize", this.events.resize, !1),
              ...
              },
              {
                ...
                value: function () {
                  (this.info = tg("<div>", { class: "df-loading-info" })),
                    ...
                    (this.loadingIcon = tg("<div>", { class: "df-loading-icon" }).appendTo(
                      this.container
                    ));
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.resize(),
                    ...
                    !0 === this.options.dataElement.hasClass("df-hash-focused") &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.append(t),
                    ...
                    this.outlineViewer.render({ outline: this.provider.outline });
                },
              },
              {
                key: "initThumbs",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.append(
                    ...
                    (e.searchButton = tg('<div class="df-ui-btn df-search-btn df-icon-search">')
                      .on("click", function (t) {
                        e.search();
                      })
                      .appendTo(e.searchForm)),
                    ...
                    (e.searchResults = tg('<div class="df-wrapper df-search-results">').appendTo(
                      t
                    )),
                    (e.searchContainer = t),
                    e.sideMenu.element.append(t),
                  ...
                  if (
                    ...
                    if ("ready" != e.state) {
                      "loading" === e.state &&
                        ...
                        "finalizing" === e.state && ((e.state = "ready"), e.finalize());
                      return;
                    }
                    e.container &&
                      e.container[0] &&
                      ...
                      ((e._offsetParent = e.container[0].offsetParent),
                      null !== e._offsetParent && (e.resize(), (e.resizeRequestStatus = tv.OFF)),
                        ...
                        e.resizeRequestStatus === tv.ON
                          ...
                          : e.resizeRequestStatus === tv.COUNT &&
                            ...
                            e.resizeRequestCount > 10 &&
                              ((e.resizeRequestCount = 0), (e.resizeRequestStatus = tv.ON))),
                        e.refreshRequestStatus === tv.ON
                          ...
                          : e.refreshRequestStatus === tv.COUNT &&
                            ...
                            e.refreshRequestCount > 3 &&
                              ((e.refreshRequestCount = 0), (e.refreshRequestStatus = tv.ON))),
                        ...
                        e.thumbRequestStatus === tv.ON
                          ...
                          : e.thumbRequestStatus === tv.COUNT &&
                            ...
                            e.thumbRequestCount > 3 &&
                              ((e.thumbRequestCount = 0), (e.thumbRequestStatus = tv.ON))),
                  ...
                  if (i.isAnimating() && !0 !== DEARFLIP.defaults.instantTextureProcess)
                    ...
                    for (var l = 0; l < a.length; l++) {
                      ...
                      if (
                        h > 0 &&
                        h <= this.pageCount &&
                        ((e = r ? i.zoomViewer.getPageByNumber(h) : i.getPageByNumber(h)) &&
              ...
              },
              {
                ...
                value: function () {
                  var e,
                    t,
                    i = (this.isSideMenuOpen = this.container.hasClass("df-sidemenu-open")),
                    o = this.dimensions,
                  ...
                  (o.offset = {
                    ...
                    this.viewerContainer.css({ left: o.offset.left, right: o.offset.right });
                  var r = (o.controlsHeight = this.container.find(".df-ui").height());
                  if (
                    ((a.top =
                      this.options.paddingTop +
                      (this.options.controlsPosition === n.CONTROLS_POSITION.TOP ? r : 0)),
                    (a.left = this.options.paddingLeft),
                    (a.right = this.options.paddingRight),
                    (a.bottom =
                      this.options.paddingBottom +
                      (this.options.controlsPosition === n.CONTROLS_POSITION.BOTTOM ? r : 0)),
                    ...
                    (o.maxHeight =
                      ...
                      null !==
                        (t = tg(
                          null !== (e = this.options.headerElementSelector) && void 0 !== e
                            ? e
                            : "#wpadminbar"
                        ).height()) &&
                      void 0 !== t
              ...
              },
              {
                ...
                value: function () {
                  var e,
                    ...
                    n = i.container[0];
                  if (
                    (i.container.toggleClass("df-fullscreen", !0 !== i.isFullscreen),
                    (null == i
                      ? void 0
                    ...
                    n.requestFullscreen
                      ...
                      : n.webkitRequestFullscreen && (o = n.webkitRequestFullscreen()),
                      o &&
                        o.then &&
                        o.then(function () {
      ...
      (n.prepareOptions = function (e) {
        ...
        return (
          ...
          "function" != typeof n.viewers[r.viewerType]
            ? (console.warn("Invalid Viewer Type! " + r.viewerType + " | Using default Viewer!"),
            ...
            if (null != a && null != a[o])
              for (var s = a[o], r = 0; r < s.length; r++) {
                ...
                l.dest && l.dest.indexOf && 0 == l.dest.indexOf("[html]")
                  ? (((h = document.createElement("div")).innerHTML = l.dest.substr(6)),
                    (h.className = "customHtmlAnnotation"))
                  : ((h = document.createElement("a")).setAttribute("dest", l.dest),
            ...
            if (o || !1 !== n.options.showSearchControl) {
              ...
              (t.innerHTML = ""),
                i.pdfDocument.getPage(a).then(function (s) {
                  ...
                  (r = s.getViewport({
                    scale:
                      n.viewer.getTextureSize({ pageNumber: e, isAnnotation: !0 }).height /
        ...
        (eJ.prototype.renderAutoLinks = function (e, t, i, n) {
          if (e && e.length > 0) {
            ...
            0 === s.length &&
              ((s = jQuery('<div class="df-auto-link-content">')), jQuery(i).parent().prepend(s)),
              s.html(""),
              (t.items = e),
              pdfjsLib.TextLayer
                ...
                for (s = 0; s < i.searchHits.length; s++)
                  (n += i.str.substring(o, i.searchHits[s].start)),
                    ...
                    void 0 !== (u = i.searchHits[s].text) &&
                      (h.indexOf("@") > 0
                        ? (u = u.toLowerCase()).indexOf(!1) && (u = "mailto:" + h)
                        : 0 === u.indexOf("www.") && (u = "http://" + u),
                      (n +=
                        '<a href="' + u + '" class="df-autolink" target="_blank">' + h + "</a>"),
              ...
              (null !== (e = o.textDivs) && void 0 !== e ? e : o._textDivs).forEach(function (e) {
                ...
                for (r = 0; r < i.searchHits.length; r++)
                  (n += i.str.substring(o, i.searchHits[r].start)),
                    ...
                    (n +=
                      '<span class="df-search-highlight">' + i.str.substring(o, o + a) + "</span>"),
                    (o += a);
                  ...
                  if (null !== n.options && null !== n.viewer && 0 != r.length) {
                    ...
                    pdfjsLib.AnnotationLayer.hasOwnProperty("render")
                      ...
                      n.options.annotationClass &&
                        "" !== n.options.annotationClass &&
                        jQuery(t).find(" > section").addClass(n.options.annotationClass),
        ...
        (n.getPDFThumb = function (e) {
            ...
            o = i.promise.then(function (t) {
              t.getPage(1).then(function (t) {
                ...
                (n = s.width > s.height ? (400 * n) / s.width : (400 * n) / s.height),
                  ...
                  t
                    .render({ canvas: a, canvasContext: a.getContext("2d"), viewport: s })
                    .promise.then(function () {
                      var t,
          ...
          i.onProgress = function (t) {
            ...
            isNaN(i)
              ...
              : e.updateInfo("Loading PDF " + Math.ceil(i).toString().split(".")[0] + "% ...");
          };
        });
      var tw = n.jQuery,
      ...
      (tP.defaults.viewerType = "flipbook"),
        ...
        (tP.CONTROLSPOSITION = { HIDDEN: "hide", TOP: "top", BOTTOM: "bottom" }),
        ...
        (tP.parseFallBack = function () {
          tw(".df-posts").addClass("dflip-books"),
            ...
            tw("._df_button, ._df_thumb, ._df_custom, ._df_book, ._df_hidden, ._df_link").each(
              function () {
                var e = tw(this);
                  ...
                  e.hasClass("_df_book") ||
                    (e.hasClass("_df_thumb")
                      ? (e.attr("data-df-lightbox", "thumb"),
                        void 0 !== e.attr("thumb") && e.data("df-thumb", e.attr("thumb")))
      ...
      var tS = function (e) {
        ...
        if (
          ...
          void 0 !== e.pageSize &&
            ("1" === e.pageSize || 1 === e.pageSize || e.pageSize === tP.FLIPBOOK_PAGE_SIZE.SINGLE
          ...
          void 0 !== e.pageMode &&
            ("1" === e.pageMode || 1 === e.pageMode || e.pageMode === tP.FLIPBOOK_PAGE_MODE.SINGLE
          ...
          void 0 !== e.scrollWheel &&
            (l.isTrue(e.scrollWheel) && (e.mouseScrollAction = tP.MOUSE_SCROLL_ACTIONS.ZOOM),
          ...
          void 0 !== e.enableDownload &&
            ((e.showDownloadControl = l.isTrue(e.enableDownload)), delete e.enableDownload),
          void 0 !== e.autoEnableOutline &&
            ((e.autoOpenOutline = l.isTrue(e.autoEnableOutline)), delete e.autoEnableOutline),
          void 0 !== e.autoEnableThumbnail &&
            ((e.autoOpenThumbnail = l.isTrue(e.autoEnableThumbnail)), delete e.autoEnableThumbnail),
          void 0 !== e.direction &&
            ("2" === e.direction || 2 === e.direction || e.direction === tP.READ_DIRECTION.RTL
      ...
      tw.fn.extend({
        flipBook: function (e, t) {
          return (
            null == t && (t = {}), (t.source = e), (t.element = tw(this)), new n.Application(t)
          );
        },
      }),
              ...
              "#" === n || void 0 === n || t.hasClass("df-hash-focused")
                ...
                : "_self" === i ||
                  ...
                  (void 0 == i && "_self" === tP.defaults.targetWindow
                    ...
                    : (o = !0)),
                o && (e.preventDefault(), e.stopPropagation(), tP.openLightBox(t));
            }),
