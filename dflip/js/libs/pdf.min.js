  ...
  (() => {
    ...
    var __webpack_modules__ = [
        ...
        (t, e, n) => {
          ...
          e.Util = class Util {
            ...
            static scaleMinMax(t, e) {
              let n;
              t[0]
                ? (t[0] < 0 && ((n = e[0]), (e[0] = e[1]), (e[1] = n)),
                  (e[0] *= t[0]),
                  (e[1] *= t[0]),
                  t[3] < 0 && ((n = e[2]), (e[2] = e[3]), (e[3] = n)),
                  (e[2] *= t[3]),
                  (e[3] *= t[3]))
                : ((n = e[0]),
                  (e[0] = e[2]),
                  ...
                  (e[1] = e[3]),
                  (e[3] = n),
                  t[1] < 0 && ((n = e[2]), (e[2] = e[3]), (e[3] = n)),
                  (e[2] *= t[1]),
                  (e[3] *= t[1]),
                  t[2] < 0 && ((n = e[0]), (e[0] = e[1]), (e[1] = n)),
                  (e[0] *= t[2]),
                  (e[1] *= t[2])),
                (e[0] += t[4]),
                (e[1] += t[4]),
            ...
            static applyInverseTransform(t, e) {
              ...
              return [
                (t[0] * e[3] - t[1] * e[2] + e[2] * e[5] - e[4] * e[3]) / n,
                (-t[0] * e[1] + t[1] * e[0] + e[4] * e[1] - e[5] * e[0]) / n,
              ];
            }
          ...
          var i = n(3),
            ...
            exportWebAssemblyErrorCauseWrapper = function (t, e) {
              if (l && l[t]) {
                var n = {};
                (n[t] = a(o + "." + t, e, c)),
                  i({ target: o, stat: !0, constructor: !0, arity: 1, forced: c }, n);
              }
            };
              ...
              if (
                ...
                "Error" !== _
                  ? o
                    ? o(x, E)
                    : l(x, E, { name: !0 })
                  : g && b in A && (c(x, A, b), c(x, A, "prepareStackTrace")),
                l(x, A),
                !f)
              )
                try {
              ...
              i(
                ...
                function (t) {
                  ...
                  for (var r, o = s(t), l = s(n), p = 0, g = 0, f = !1, m = i.length; p < m; )
                    (r = i[p++]), f || r.key === o ? ((f = !0), h(this, r.key)) : g++;
                  for (; g < m; )
        ...
        (t, e, n) => {
          ...
          if ((!N || !M || M === R) && ((M = k.prototype), N))
            for (i in j) l[i] && y(l[i].prototype, M);
        ...
        (t, e, n) => {
          ...
          t.exports =
            ...
            function (t, e, n) {
              ...
              for (
                var f = n && !s && y ? { maxByteLength: y(c) } : void 0,
                  m = new u(r, f),
                  S = new p(c),
                  E = new p(m),
                  x = g(r, i),
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            ...
            if (
              (I ||
                ((N.cMapReaderFactory = new f({ baseUrl: p, isCompressed: g })),
                (N.standardFontDataFactory = new b({ baseUrl: m }))),
              !h)
            ) {
          ...
          async function _fetchDocument(t, e) {
            ...
            const n = await t.messageHandler.sendWithPromise(
              "GetDocRequest",
              e,
          ...
          class PDFPageProxy {
            ...
            render(t) {
              ...
              u || ((u = Object.create(null)), this._intentStates.set(d.cacheKey, u)),
                u.streamReaderCancelTimeout &&
                  (clearTimeout(u.streamReaderCancelTimeout), (u.streamReaderCancelTimeout = null));
              ...
              const complete = (t) => {
                ...
                g = new InternalRenderTask({
                  callback: complete,
                  params: { canvasContext: e, viewport: n, transform: s, background: a },
                  objs: this.objs,
                  ...
                  .then((t) => {
                    ...
                    this.destroyed
                      ...
                      : (this._stats?.time("Rendering"),
                        g.initializeGraphics({ transparency: e, optionalContentConfig: n }),
                ...
                s.opListReadCapability ||
                  ...
                  (r.operatorListChanged = function operatorListChanged() {
                    s.operatorList.lastChunk &&
                      (s.opListReadCapability.resolve(s.operatorList), s.renderTasks.delete(r));
                  }),
              ...
              return new Promise(function (t, n) {
                ...
                !(function pump() {
                  i.read().then(function (e) {
                    ...
                    i
                      ? t(r)
                      : (Object.assign(r.styles, n.styles), r.items.push(...n.items), pump());
                  }, n);
                })();
              });
            }
            ...
            _destroy() {
              ...
              for (const e of this._intentStates.values())
                if (
                  ...
                  for (const n of e.renderTasks) t.push(n.completed), n.cancel();
            ...
            _pumpOperatorList(t) {
              ...
              const { map: r, transfers: s } = i,
                a = this._transport.messageHandler
                  .sendWithStream(
                    "GetOperatorList",
                    { pageIndex: this._pageIndex, intent: e, cacheKey: n, annotationStorage: r },
                    s
                  )
                  .getReader(),
              ...
              const pump = () => {
                a.read().then(
                  (t) => {
                    ...
                    n
                      ? (o.streamReader = null)
                      : this._transport.destroyed || (this._renderPageChunk(e, o), pump());
                  },
                  (t) => {
                  ...
                  if (n instanceof _display_utils.RenderingCancelledException) {
                    ...
                    return (
                      ...
                      void (e.streamReaderCancelTimeout = setTimeout(() => {
                        (e.streamReaderCancelTimeout = null),
                          this._abortOperatorList({ intentState: e, reason: n, force: !0 });
                      }, t))
                    );
                  }
                }
          ...
          class PDFWorker {
            ...
            constructor() {
              ...
              if (
                ...
                return (
                  (PDFWorker.#l ||= new WeakMap()).set(e, this), void this._initializeFromPort(e)
                );
              }
              this._initialize();
            }
              ...
              if (!PDFWorkerUtil.isWorkerDisabled && !PDFWorker._mainThreadWorkerMessageHandler) {
                ...
                try {
                  ...
                  e.addEventListener("error", onWorkerError),
                    ...
                    n.on("ready", (t) => {
                      if ((e.removeEventListener("error", onWorkerError), this.destroyed))
                        terminateEarly();
                      else
                        try {
                          sendTest();
            ...
            getRenderingIntent(t) {
              ...
              switch (e) {
                ...
                case _util.AnnotationMode.ENABLE_STORAGE:
                  ...
                  s = (
                    r & _util.RenderingIntentFlag.PRINT &&
                    n instanceof _annotation_storage.PrintAnnotationStorage
                      ? n
              ...
              return (
                ...
                { renderingIntent: r, cacheKey: `${r}_${s.hash}`, annotationStorageSerializable: s }
              );
            }
            destroy() {
                  ...
                  if (!this.destroyed && !this.commonObjs.has(n))
                    switch (i) {
                      case "Font":
                        ...
                        const s =
                            e.pdfBug && globalThis.FontInspector?.enabled
        ...
        (t, e, n) => {
          var i = n(3),
            r = n(126);
          i(
            { target: "Set", proto: !0, real: !0, forced: !n(135)("difference") },
            { difference: r }
          );
        },
        (t, e, n) => {
        ...
        (t, e, n) => {
          ...
          t.exports = function (t, e, n) {
            for (var r, s, a = n ? t : t.iterator, o = t.next; !(r = i(o, a)).done; )
              if (void 0 !== (s = e(r.value))) return s;
          };
        },
        (t, e, n) => {
          var i = n(72),
        ...
        (t, e, n) => {
          var i = n(3),
            r = n(139);
          i(
            { target: "Set", proto: !0, real: !0, forced: !n(135)("isDisjointFrom") },
            { isDisjointFrom: r }
          );
        },
        (t, e, n) => {
        ...
        (t, e, n) => {
          var i = n(3),
            r = n(142);
          i(
            { target: "Set", proto: !0, real: !0, forced: !n(135)("isSubsetOf") },
            { isSubsetOf: r }
          );
        },
        (t, e, n) => {
        ...
        (t, e, n) => {
          var i = n(3),
            r = n(144);
          i(
            { target: "Set", proto: !0, real: !0, forced: !n(135)("isSupersetOf") },
            { isSupersetOf: r }
          );
        },
        (t, e, n) => {
        ...
        (t, e, n) => {
          var i = n(3),
            r = n(146);
          i(
            { target: "Set", proto: !0, real: !0, forced: !n(135)("symmetricDifference") },
          ...
          var i,
            ...
            structuredCloneInternal = function (t, e, n) {
              ...
              switch (m) {
                ...
                case "BigUint64Array":
                  (h = "DataView" === m ? t.byteLength : t.length),
                    (s = n
                      ? new Placeholder(t, m, { offset: t.byteOffset, length: h })
                      : cloneView(t, m, t.byteOffset, h, e));
                  break;
                case "DOMQuad":
                  try {
                    s = new DOMQuad(
                      structuredCloneInternal(t.p1, e, n),
                      structuredCloneInternal(t.p2, e, n),
                      structuredCloneInternal(t.p3, e, n),
                      structuredCloneInternal(t.p4, e, n)
                    );
                  } catch (e) {
              ...
              switch ((K(e, t, s), m)) {
                case "Array":
                case "Object":
                  for (u = Q(t), c = 0, h = S(u); c < h; c++)
                    (p = u[c]), _(s, p, structuredCloneInternal(t[p], e, n));
                  break;
                case "Map":
        ...
        (t, e, n) => {
          ...
          class AnnotationStorage {
            ...
            setValue(t, e) {
              ...
              let i = !1;
              if (void 0 !== n)
                for (const [t, r] of Object.entries(e)) n[t] !== r && ((i = !0), (n[t] = r));
              else (i = !0), this.#y.set(t, e);
              i && this.#_(),
                e instanceof r.AnnotationEditor &&
                  "function" == typeof this.onAnnotationEditor &&
            ...
            #_() {
              this.#v ||
                ((this.#v = !0), "function" == typeof this.onSetModified && this.onSetModified());
            }
            resetModified() {
              this.#v &&
                ((this.#v = !1),
          ...
          class AnnotationEditor {
            ...
            constructor(t) {
              this.constructor === AnnotationEditor &&
                (0, r.unreachable)("Cannot initialize AnnotationEditor."),
            ...
            static initialize(t) {
              ...
              if (
                ...
                for (const n of e.strings) AnnotationEditor._l10nPromise.set(n, t.get(n));
            ...
            #W(t, e) {
              ...
              var w, C;
              if (
                (([E, x] = ((w = E / n), (C = x / i), [d[0] * w + d[2] * C, d[1] * w + d[3] * C])),
                g)
              ) {
                const t = Math.hypot(a, o);
                A = S = Math.max(
                  Math.min(Math.hypot(b[0] - m[0] - E, b[1] - m[1] - x) / t, 1 / a, 1 / o),
                  l / a,
                  c / o
                );
              } else
                f
                  ? (A = Math.max(l, Math.min(1, Math.abs(b[0] - m[0] - E))) / a)
                  : (S = Math.max(c, Math.min(1, Math.abs(b[1] - m[1] - x))) / o);
              const T = round(a * A),
                P = round(o * S);
              v = transf(...p(T, P));
              const k = y - v[0],
            ...
            async addAltTextButton() {
              ...
              if (
                ...
                t.addEventListener("keydown", (e) => {
                  e.target === t &&
                    "Enter" === e.key &&
                    (e.preventDefault(), this._uiManager.editAltText(this));
                }),
                this.#q(),
                this.div.append(t),
            ...
            render() {
              ...
              return (
                this.translate(n, r), (0, i.bindEvents)(this, this.div, ["pointerdown"]), this.div
              );
            }
            pointerdown(t) {
        ...
        (t, e, n) => {
          ...
          class CommandManager {
            ...
            add(t) {
              ...
              if (-1 === this.#Q)
                return (
                  this.#K.length > 0 && (this.#K.length = 0), (this.#Q = 0), void this.#K.push(o)
                );
              if (s && this.#K[this.#Q].type === r)
                return a && (o.undo = this.#K[this.#Q].undo), void (this.#K[this.#Q] = o);
              const l = this.#Q + 1;
              l === this.#J
                ? this.#K.splice(0, 1)
                : ((this.#Q = l), l < this.#K.length && this.#K.splice(l)),
                this.#K.push(o);
            }
            undo() {
              -1 !== this.#Q &&
                ((this.#Y = !0), this.#K[this.#Q].undo(), (this.#Y = !1), (this.#Q -= 1));
            }
            redo() {
              this.#Q < this.#K.length - 1 &&
                ((this.#Q += 1), (this.#Y = !0), this.#K[this.#Q].cmd(), (this.#Y = !1));
            }
            hasSomethingToUndo() {
              return -1 !== this.#Q;
            }
          ...
          class KeyboardManager {
            constructor(t) {
              ...
              for (const [n, i, r = {}] of t)
                for (const t of n) {
                  ...
                  e && n
                    ? (this.callbacks.set(t.slice(4), { callback: i, options: r }),
                      this.allKeys.add(t.split("+").at(-1)))
                    : e ||
                      n ||
                      (this.callbacks.set(t, { callback: i, options: r }),
                      this.allKeys.add(t.split("+").at(-1)));
                }
            }
            #Z(t) {
            ...
            exec(t, e) {
              ...
              (a && !a(t, e)) ||
                (i.bind(t, ...s)(), r || (e.stopPropagation(), e.preventDefault()));
            }
          }
          ...
          class ColorManager {
            ...
            convert(t) {
              ...
              for (const [t, n] of this._colors)
                if (n.every((t, n) => t === e[n])) return ColorManager._colorsMapping.get(t);
              return e;
            }
            getHexCode(t) {
          ...
          class AnnotationEditorUIManager {
            ...
            get hcmFilter() {
              return (0, i.shadow)(
                this,
                "hcmFilter",
                this.#vt ? this.#dt.addHCMFilter(this.#vt.foreground, this.#vt.background) : "none"
              );
            }
            get direction() {
            ...
            updateMode(t) {
              let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
              if (this.#mt !== t) {
                if (((this.#mt = t), t === i.AnnotationEditorType.NONE))
                  return this.setEditingState(!1), void this.#Gt();
            ...
            toggleSelected(t) {
              if (this.#bt.has(t))
                return (
                  this.#bt.delete(t),
                  t.unselect(),
                  void this.#Wt({ hasSelectedEditor: this.hasSelection })
                );
              this.#bt.add(t),
                t.select(),
            ...
            addCommands(t) {
              this.#st.add(t),
                this.#Wt({ hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#Ht() });
            }
            #Ht() {
        ...
        (t, e, n) => {
          ...
          Context.prototype = {
            ...
            object: function () {
              for (
                var t = this.source, e = this.index + 1, n = !1, i = {}, r = {};
                e < t.length;
            ...
            array: function () {
              for (
                ...
                if ((P(r, s), P(i, s.value), (e = this.until([",", "]"], s.end)), "," === w(t, e)))
                  (n = !0), e++;
                else if ("]" === w(t, e)) {
                  e++;
                  break;
            ...
            number: function () {
              ...
              if (
                ("." === w(t, n) && (n = this.skip(k, ++n)), "e" === w(t, n) || "E" === w(t, n)) &&
                (n++, ("+" !== w(t, n) && "-" !== w(t, n)) || n++, n === (n = this.skip(k, n)))
              )
        ...
        (t, e, n) => {
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (e.getPdfFilenameFromUrl = function getPdfFilenameFromUrl(t) {
              let e =
                arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "document.pdf";
          ...
          class DOMFilterFactory extends i.BaseFilterFactory {
            ...
            addFilter(t) {
              ...
              if (1 === t.length) {
                ...
                const [s, a, o] = t,
                  ...
                  h = new Array(256);
                for (let t = 0; t < 256; t++)
                  (l[t] = s[t] / 255), (c[t] = a[t] / 255), (h[t] = o[t] / 255);
            ...
            addHCMFilter(t, e) {
              ...
              if (((this.#Jt = n), (this.#Qt = "none"), this.#Yt?.remove(), !t || !e))
                return this.#Qt;
              const i = this.#se(t);
              ...
              return (
                this.#re(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), c),
                (this.#Qt = `url(#${l})`),
                this.#Qt
              );
            }
            addHighlightHCMFilter(t, e, n, i) {
              ...
              if (((this.#te = r), (this.#ee = "none"), this.#Zt?.remove(), !t || !e))
                return this.#ee;
            ...
            destroy() {
              (arguments.length > 0 &&
                ...
                arguments[0] &&
                (this.#Qt || this.#ee)) ||
                (this.#Xt && (this.#Xt.parentNode.parentNode.remove(), (this.#Xt = null)),
                this.#$t && (this.#$t.clear(), (this.#$t = null)),
                (this.#G = 0));
            }
            #ae(t) {
                    ...
                    if (200 === s.status || 0 === s.status) {
                      ...
                      if (
                        (e && s.response
                          ...
                          : !e && s.responseText && (t = (0, r.stringToBytes)(s.responseText)),
                        t)
                      )
                        return void n(t);
                    }
          ...
          e.StatTimer = class StatTimer {
            ...
            times = [];
            time(t) {
              t in this.started && (0, r.warn)(`Timer is already running for ${t}`),
                (this.started[t] = Date.now());
            }
            timeEnd(t) {
              t in this.started || (0, r.warn)(`Timer has not been started for ${t}`),
          ...
          class BaseStandardFontDataFactory {
            constructor(t) {
              ...
              this.constructor === BaseStandardFontDataFactory &&
                (0, i.unreachable)("Cannot initialize BaseStandardFontDataFactory."),
                (this.baseUrl = e);
            }
            async fetch(t) {
              let { filename: e } = t;
          ...
          class BaseSVGFactory {
            ...
            create(t, e) {
              ...
              return (
                ...
                n || (i.setAttribute("width", `${t}px`), i.setAttribute("height", `${e}px`)),
          ...
          e.MurmurHash3_64 = class MurmurHash3_64 {
            ...
            hexdigest() {
              ...
              return (
                ...
                (e =
                  ((4283543511 * e) & s) | (((2950163797 * ((e << 16) | (t >>> 16))) & s) >>> 16)),
                (t ^= e >>> 1),
                (t = ((444984403 * t) & s) | ((60499 * t) & a)),
                (e =
                  ((3301882366 * e) & s) | (((3120437893 * ((e << 16) | (t >>> 16))) & s) >>> 16)),
                (t ^= e >>> 1),
              ...
              if (this.isFontLoadingAPISupported) {
                ...
                if (e) {
                  ...
                  try {
                    ...
                    throw (
                      ((0, i.warn)(`Failed to load font '${e.family}': '${n}'.`),
                      (t.disableFontFace = !0),
                      n)
                    );
                  }
          ...
          e.FontFaceObject = class FontFaceObject {
            ...
            getPathGenerator(t, e) {
              ...
              return (this.compiledGlyphs[e] = function (t, e) {
                for (const i of n)
                  "scale" === i.cmd && (i.args = [e, -e]), t[i.cmd].apply(t, i.args);
              });
            }
          };
        },
        ...
        (t, e, n) => {
          ...
          class CachedCanvases {
            ...
            getCanvas(t, e, n) {
              ...
              return (
                void 0 !== this.cache[t]
                  ? ((i = this.cache[t]), this.canvasFactory.reset(i, e, n))
                  : ((i = this.canvasFactory.create(e, n)), (this.cache[t] = i)),
                i
              );
            }
            delete(t) {
          ...
          function drawImageAtIntegerCoords(t, e, n, i, s, a, o, l, c, h) {
            ...
            if (0 === u && 0 === p) {
              ...
              return (
                t.setTransform(Math.sign(d), 0, 0, Math.sign(g), b, y),
          ...
          class CanvasExtraState {
            ...
            getPathBoundingBox() {
              let t =
                  arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : s.PathType.FILL,
          ...
          function putBinaryImageData(t, e) {
            ...
            if (e.kind === i.ImageKind.GRAYSCALE_1BPP) {
                ...
                for (m = g < a ? l : s, h = 0, f = 0; f < m; f++) {
                  ...
                  for (; i < a; i += 8)
                    (l = u[d++]),
                      ...
                      (n[h++] = 1 & l ? y : _);
                  for (; i < s; i++)
                    0 === o && ((l = u[d++]), (o = 128)), (n[h++] = l & o ? y : _), (o >>= 1);
                }
                for (; h < b; ) n[h++] = 0;
                t.putImageData(c, 0, g * l);
              }
            } else if (e.kind === i.ImageKind.RGBA_32BPP) {
              for (f = 0, b = r * l * 4, g = 0; g < a; g++)
                p.set(u.subarray(d, d + b)), (d += b), t.putImageData(c, 0, f), (f += l);
              ...
              for (m = l, b = r * m, g = 0; g < o; g++) {
                for (g >= a && ((m = s), (b = r * m)), h = 0, f = b; f--; )
                  (p[h++] = u[d++]), (p[h++] = u[d++]), (p[h++] = u[d++]), (p[h++] = 255);
                t.putImageData(c, 0, g * l);
              }
            }
          }
          function putBinaryImageMask(t, e) {
            ...
            for (let e = 0; e < o; e++) {
              const n = e < s ? l : r;
              ({ srcPos: h } = (0, a.convertBlackAndWhiteToRGBA)({
                src: d,
                srcPos: h,
                dest: u,
                width: i,
          ...
          class CanvasGraphics {
            ...
            _scaleImage(t, e) {
              ...
              for (; (a > 2 && l > 1) || (o > 2 && c > 1); ) {
                ...
                a > 2 &&
                  l > 1 &&
                  ((e = l >= 16384 ? Math.floor(l / 2) - 1 || 1 : Math.ceil(l / 2)), (a /= l / e)),
                  o > 2 &&
                    c > 1 &&
            ...
            _createMaskCanvas(t) {
              ...
              if ((t.bitmap || t.data) && t.count > 1) {
                ...
                (d = JSON.stringify(l ? c : [c.slice(0, 4), o])),
                  ...
                  h || ((h = new Map()), this._cachedBitmapsMap.set(e, h));
                const n = h.get(d);
                if (n && !l) {
                  return {
                    canvas: n,
              ...
              const x = i.Util.transform((0, r.getCurrentTransformInverse)(A), [
                1,
                0,
                0,
                1,
              ...
              return (
                (A.fillStyle = l ? o.getPattern(e, this, x, s.PathType.FILL) : o),
                A.fillRect(0, 0, n, a),
                h && !l && (this.cachedCanvases.delete("fillCanvas"), h.set(d, _.canvas)),
                { canvas: _.canvas, offsetX: Math.round(S), offsetY: Math.round(E) }
              );
            }
            setLineWidth(t) {
            ...
            save() {
              this.inSMaskMode
                ? (copyCtxState(this.ctx, this.suspendedCtx), this.suspendedCtx.save())
                : this.ctx.save();
            ...
            restore() {
              0 === this.stateStack.length && this.inSMaskMode && this.endSMaskMode(),
                0 !== this.stateStack.length &&
                  ...
                  this.inSMaskMode
                    ? (this.suspendedCtx.restore(), copyCtxState(this.suspendedCtx, this.ctx))
                    : this.ctx.restore(),
                  this.checkSMaskState(),
                  (this.pendingClip = null),
                ...
                switch (0 | t[n]) {
                  case i.OPS.rectangle:
                    ...
                    s.moveTo(c, h),
                      0 === t || 0 === n
                        ? s.lineTo(g, f)
                        : (s.lineTo(g, h), s.lineTo(g, f), s.lineTo(c, f)),
            ...
            stroke() {
              ...
              (e.globalAlpha = this.current.strokeAlpha),
                this.contentVisible &&
                  ("object" == typeof n && n?.getPattern
                    ? (e.save(),
                      (e.strokeStyle = n.getPattern(
                        e,
                        this,
            ...
            setFont(t, e) {
              ...
              if (
                ...
                e < 0 ? ((e = -e), (r.fontDirection = -1)) : (r.fontDirection = 1),
                (this.current.font = n),
            ...
            showText(t) {
              ...
              if ((1 !== l && (o.scale(l, l), (_ /= l)), (o.lineWidth = _), n.isInvalidPDFjsFont)) {
                ...
                return (
                  o.fillText(n.join(""), 0, 0), (e.x += i * b * u), o.restore(), void this.compose()
                );
              }
              let S,
                E = 0;
            ...
            beginGroup(t) {
              ...
              m.scale(1 / u, 1 / p),
                ...
                t.smask
                  ...
                  : (e.setTransform(1, 0, 0, 1, 0, 0), e.translate(l, c), e.scale(u, p), e.save()),
                copyCtxState(e, m),
                (this.ctx = m),
                this.setGState([
                  ["BM", "source-over"],
              ...
              if (
                ...
                (void 0 === i.compiled &&
                  (i.compiled = (function compileType3Glyph(t) {
                    ...
                    let u = 0;
                    for (d = 0, 0 !== h[d] && ((l[0] = 1), ++u), a = 1; a < e; a++)
                      h[d] !== h[d + 1] && ((l[a] = h[d] ? 2 : 1), ++u), d++;
                    for (0 !== h[d] && ((l[a] = 2), ++u), s = 1; s < n; s++) {
                      ...
                      for (a = 1; a < e; a++)
                        (t = (t >> 2) + (h[d + 1] ? 4 : 0) + (h[d - c + 1] ? 8 : 0)),
                          i[t] && ((l[o + a] = i[t]), ++u),
                          d++;
                      if ((h[d - c] !== h[d] && ((l[o + a] = h[d] ? 2 : 4), ++u), u > 1e3))
                        return null;
                    }
                    for (
                      d = c * (n - 1), o = s * r, 0 !== h[d] && ((l[o] = 8), ++u), a = 1;
                      a < e;
                      a++
                    )
                      h[d] !== h[d + 1] && ((l[o + a] = h[d] ? 4 : 8), ++u), d++;
            ...
            paintImageMaskXObjectGroup(t) {
              ...
              for (const a of t) {
                ...
                putBinaryImageMask(d, this.getObject(t, a)),
                  ...
                  (d.fillStyle = i
                    ? n.getPattern(d, this, (0, r.getCurrentTransformInverse)(e), s.PathType.FILL)
                    : n),
                  d.fillRect(0, 0, o, l),
                  d.restore(),
                  e.save(),
            ...
            paintImageXObjectRepeat(t, e, n, r) {
              ...
              for (let t = 0, i = r.length; t < i; t += 2)
                l.push({ transform: [e, 0, 0, n, r[t], r[t + 1]], x: 0, y: 0, w: a, h: o });
        ...
        (t, e, n) => {
          ...
          class RadialAxialShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, n, a) {
              ...
              if (a === s.STROKE || a === s.FILL) {
                const s = e.current.getClippedPathBoundingBox(a, (0, r.getCurrentTransform)(t)) || [
                    0, 0, 0, 0,
                  ],
          ...
          function drawTriangle(t, e, n, i, r, s, a, o) {
            const l = e.coords,
              ...
              d = 4 * t.width;
            let u;
            l[n + 1] > l[i + 1] && ((u = n), (n = i), (i = u), (u = s), (s = a), (a = u)),
              l[i + 1] > l[r + 1] && ((u = i), (i = r), (r = u), (u = a), (a = o), (o = u)),
              l[n + 1] > l[i + 1] && ((u = n), (n = i), (i = u), (u = s), (s = a), (a = u));
          ...
          class MeshShadingPattern extends BaseShadingPattern {
            ...
            _createMeshCanvas(t, e, n) {
              ...
              if (e) {
                ...
                for (let n = 0, i = t.length; n < i; n += 4)
                  (t[n] = e[0]), (t[n + 1] = e[1]), (t[n + 2] = e[2]), (t[n + 3] = 255);
              }
            ...
            getPattern(t, e, n, a) {
              let o;
              if ((applyBoundingBox(t, this._bbox), a === s.SHADING))
                o = i.Util.singularValueDecompose2dScale((0, r.getCurrentTransform)(t));
          ...
          class TilingPattern {
            ...
            createPatternCanvas(t) {
              ...
              let E = d,
                ...
                C = g;
              return (
                d < 0 && ((E = 0), (w += Math.abs(d))),
                u < 0 && ((x = 0), (C += Math.abs(u))),
                ...
                S.endDrawing(),
                { canvas: _.canvas, scaleX: v.scale, scaleY: y.scale, offsetX: E, offsetY: x }
              );
            }
        ...
        (t, e, n) => {
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (e.grayToRGBA = function grayToRGBA(t, e) {
              if (i.FeatureTest.isLittleEndian)
                for (let n = 0, i = t.length; n < i; n++) e[n] = (65793 * t[n]) | 4278190080;
                ...
                d = {
                  enqueue(t) {
                    ...
                    (this.desiredSize -= a),
                      ...
                      s.postMessage(
                        { sourceName: n, targetName: r, stream: c, streamId: e, chunk: t },
                        o
                      );
                  },
                  close() {
                    this.isCancelled ||
                      ((this.isCancelled = !0),
                      s.postMessage({ sourceName: n, targetName: r, stream: l, streamId: e }),
            ...
            #de(t) {
              ...
              switch (t.stream) {
                ...
                case d:
                  ...
                  break;
                case c:
                  if (((0, i.assert)(g, "enqueue should have stream controller"), g.isClosed))
                    break;
        ...
        (t, e, n) => {
          ...
          e.OptionalContentConfig = class OptionalContentConfig {
            ...
            #Ae(t) {
              ...
              for (let r = 1; r < e; r++) {
                ...
                if (Array.isArray(e)) s = this.#Ae(e);
                  ...
                  if (!this.#ve.has(e))
                    return (0, i.warn)(`Optional content group not found: ${e}`), !0;
            ...
            isVisible(t) {
              ...
              if ("OCG" === t.type)
                return this.#ve.has(t.id)
                  ? this.#ve.get(t.id).visible
                  : ((0, i.warn)(`Optional content group not found: ${t.id}`), !0);
              if ("OCMD" === t.type) {
            ...
            setVisibility(t) {
              let e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
              this.#ve.has(t)
                ? (this.#ve.get(t)._setVisible(s, !!e), (this.#be = null))
        ...
        (t, e, n) => {
          ...
          e.PDFDataTransportStream = class PDFDataTransportStream {
            ...
            getRangeReader(t, e) {
              ...
              return (
                this._pdfDataRangeTransport.requestDataRange(t, e), this._rangeReaders.push(n), n
              );
            }
            cancelAllRequests(t) {
          ...
          class PDFFetchStreamReader {
            constructor(t) {
              ...
              fetch(
                ...
                .then((t) => {
                  if (!(0, r.validateResponseStatus)(t.status))
                    throw (0, r.createResponseStatusError)(t.status, n);
          ...
          class PDFFetchStreamRangeReader {
            constructor(t, e, n) {
              ...
              fetch(
                ...
                .then((t) => {
                  if (!(0, r.validateResponseStatus)(t.status))
                    throw (0, r.createResponseStatusError)(t.status, a);
              ...
              function getFilenameFromContentDispositionHeader(t) {
                ...
                if (
                  ((n = (function rfc2231getparam(t) {
                    ...
                    for (let t = 0; t < e.length && t in e; ++t) {
                      let [n, i] = e[t];
                      (i = rfc2616unquote(i)),
                        n && ((i = unescape(i)), 0 === t && (i = rfc5987decode(i))),
                        r.push(i);
                    }
                    return r.join("");
                  })(t)),
                ...
                function fixupEncoding(t) {
                  return (
                    e &&
                      /[\x80-\xff]/.test(t) &&
                      ((t = textdecode("utf-8", t)), e && (t = textdecode("iso-8859-1", t))),
                    t
                  );
                }
                function rfc2616unquote(t) {
                  if (t.startsWith('"')) {
                    ...
                    for (let t = 0; t < e.length; ++t) {
                      const n = e[t].indexOf('"');
                      -1 !== n && ((e[t] = e[t].slice(0, n)), (e.length = t + 1)),
        ...
        (t, e, n) => {
          ...
          class BaseFullReader {
            ...
            async read() {
              ...
              if (null === t)
                return (this._readCapability = new i.PromiseCapability()), this.read();
        ...
        (t, e, n) => {
            ...
            h = (function () {
              ...
              function encode(e, n, i, s) {
                ...
                let p = 0,
                  g = 0;
                for (let t = 0; t < o; ++t)
                  (u[p++] = 0), u.set(d.subarray(g, g + h), p), (g += h), (p += h);
          ...
          function pm(t) {
            ...
            return `matrix(${pf(t[0])} ${pf(t[1])} ${pf(t[2])} ${pf(t[3])} ${pf(t[4])} ${pf(
              t[5]
            )})`;
          }
          let d = 0,
          ...
          e.SVGGraphics = class SVGGraphics {
            ...
            showText(t) {
              ...
              if (
                (v === r.TextRenderingMode.FILL || v === r.TextRenderingMode.FILL_STROKE
                  ...
                  : e.textRenderingMode === r.TextRenderingMode.ADD_TO_PATH
              ...
              let y = e.textMatrix;
              0 !== e.textRise && ((y = y.slice()), (y[5] += e.textRise)),
            ...
            _makeTilingPattern(t) {
              const e = t[1],
                ...
                d = t[7],
                u = "shading" + p++,
                [g, f, m, b] = r.Util.normalizeRect([
                  ...r.Util.applyTransform([s, a], i),
                  ...r.Util.applyTransform([o, l], i),
                ]),
            ...
            paintImageXObject(t) {
              ...
              e
                ...
                : (0, r.warn)(`Dependent image with object ID ${t} is not ready yet`);
            }
            ...
            _initialize(t) {
              ...
              return (
                i.setAttributeNS(null, "transform", pm(t.transform)), e.append(i), (this.svg = i), e
              );
            }
            _ensureClipGroup() {
        ...
        (t, e, n) => {
          ...
          t.exports = function (t, e, n, r) {
            for (
              var p, g, f, m = a(t), b = s(m), v = i(e, n), y = c(null), _ = l(b), A = 0;
              _ > A;
              A++
            )
              (f = b[A]), (g = o(v(f, A, m))) in y ? u(y[g], f) : (y[g] = [f]);
                ...
                (function walk(t) {
                  ...
                  if ("#text" === i) n = t.value;
                    ...
                    t?.attributes?.textContent
                      ? (n = t.attributes.textContent)
                      : t.value && (n = t.value);
                  }
                  if ((null !== n && e.push({ str: n }), t.children))
        ...
        (t, e, n) => {
          ...
          function appendText(t, e, n) {
            ...
            0 === h
              ? ((g = c[4]), (f = c[5] - p))
              : ((g = c[4] + p * Math.sin(h)), (f = c[5] - p * Math.cos(h)));
            ...
            t._container === t._rootContainer
              ...
              : ((b.left = `${m}${g.toFixed(2)}px)`), (b.top = `${m}${f.toFixed(2)}px)`)),
          ...
          function layout(t) {
            ...
            if (0 !== i.canvasWidth && i.hasText) {
              ...
              (s === d && a === c) ||
                ((r.font = `${d * n}px ${c}`), (t.prevFontSize = d), (t.prevFontFamily = c));
              ...
              if (this._isReadableStream) {
                const pump = () => {
                  this._reader.read().then((n) => {
                    ...
                    r
                      ? t.resolve()
                      : (Object.assign(e, i.styles), this._processItems(i.items, e), pump());
                  }, t.reject);
                };
        ...
        (t, e, n) => {
          ...
          class AnnotationEditorLayer {
            ...
            updateMode() {
              let t =
                arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.#Fe.getMode();
              this.#Re(),
            ...
            addInkEditorIfNeeded(t) {
              ...
              if (!t)
                for (const t of this.#Te.values()) if (t.isEmpty()) return void t.setInBackground();
            ...
            enable() {
              ...
              for (const e of this.#Te.values())
                e.enableEditing(), e.annotationElementId && t.add(e.annotationElementId);
              if (!this.#xe) return;
            ...
            disable() {
              ...
              for (const e of this.#Te.values())
                e.disableEditing(),
                  e.annotationElementId && null === e.serialize()
            ...
            add(t) {
              if (
                (this.changeParent(t), this.#Fe.addEditor(t), this.attach(t), !t.isAttachedToDOM)
              ) {
                const e = t.render();
            ...
            pointerup(t) {
              ...
              0 !== t.button ||
                ...
                (t.target === this.div &&
                  ...
                  ((this.#Pe = !1),
                  this.#Ee
                    ? this.#Fe.getMode() !== i.AnnotationEditorType.STAMP
                      ? this.#De(t, !1)
                      : this.#Fe.unselectAll()
                    : (this.#Ee = !0)));
            }
            ...
            destroy() {
              this.#Fe.getActive()?.parent === this &&
                (this.#Fe.commitOrRemove(), this.#Fe.setActiveEditor(null));
          ...
          class FreeTextEditor extends s.AnnotationEditor {
            ...
            constructor(t) {
              super({ ...t, name: "freeTextEditor" }),
                (this.#Ue =
                  t.color || FreeTextEditor._defaultColor || s.AnnotationEditor._defaultLineColor),
            ...
            static get defaultPropertiesToUpdate() {
              return [
                ...
                [
                  ...
                  FreeTextEditor._defaultColor || s.AnnotationEditor._defaultLineColor,
                ],
              ];
            }
            get propertiesToUpdate() {
            ...
            getInitialTranslation() {
              ...
              return [
                ...
                -(FreeTextEditor._internalPadding + this.#qe) * t,
              ];
            }
            rebuild() {
              this.parent &&
            ...
            #$e() {
              ...
              this.rotation % 180 == this.parentRotation % 180
                ? ((this.width = n.width / t), (this.height = n.height / e))
                : ((this.width = n.height / t), (this.height = n.width / e)),
                this.fixAndSetPosition();
            }
            commit() {
              ...
              const setText = (t) => {
                (this.#ze = t),
                  t ? (this.#Ye(), this._uiManager.rebuild(this), this.#$e()) : this.remove();
              };
              this.addCommands({
                cmd: () => {
                  setText(e);
            ...
            render() {
              ...
              if (
                ((n.fontSize = `calc(${this.#qe}px * var(--scale-factor))`),
                (n.color = this.#Ue),
            ...
            serialize() {
              ...
              const e = FreeTextEditor._internalPadding * this.parentScale,
                n = this.getRect(e, e),
                r = s.AnnotationEditor._colorManager.convert(
                  this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Ue
                ),
                a = {
                  annotationType: i.AnnotationEditorType.FREETEXT,
                  color: r,
              ...
              return t
                ? a
                : this.annotationElementId && !this.#Je(a)
                ? null
            ...
            #Je(t) {
              ...
              return (
                t.value !== e ||
                t.fontSize !== n ||
                t.rect.some((t, e) => Math.abs(t - r[e]) >= 1) ||
            ...
            #Xe() {
              ...
              if ((this.#$e(), !t && (0 === this.width || 0 === this.height)))
        ...
        (t, e, n) => {
            ...
            _createContainer(t) {
              ...
              const { width: d, height: u } = getRectDims(e.rect),
                p = i.Util.normalizeRect([
                  e.rect[0],
                  n.view[3] - e.rect[1] + n.view[1],
                  e.rect[2],
                  n.view[3] - e.rect[3] + n.view[1],
                ]);
              ...
              return (
                e.hasOwnCanvas || 0 === g
                  ? ((s.style.width = (100 * d) / a + "%"), (s.style.height = (100 * u) / o + "%"))
                  : this.setRotation(g, s),
                s
              );
            }
            setRotation(t) {
            ...
            _createQuadrilaterals() {
              ...
              for (const [, { x: n, y: i }, { x: s, y: h }] of t) {
                ...
                t.setAttribute("x", d),
                  ...
                  u.append(t),
                  a?.push(
                    `<rect vector-effect="non-scaling-stroke" x="${d}" y="${p}" width="${g}" height="${f}"/>`
                  );
              }
              this.#Qe && (a.push("</g></svg>')"), (s.backgroundImage = a.join(""))),
              ...
              if (this._fieldObjects) {
                ...
                if (r)
                  for (const { page: t, id: s, exportValues: a } of r) {
                    ...
                    !o || h.has(o)
                      ? n.push({ id: s, exportValue: r, domElement: o })
                      : (0, i.warn)(`_getElementsByName - element not allowed: ${s}`);
                  }
                return n;
              }
          ...
          class LinkAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              return (
                t.url
                  ? (e.addLinkAttributes(n, t.url, t.newWindow), (i = !0))
                  : t.action
                  ? (this._bindNamedAction(n, t.action), (i = !0))
                  : t.attachment
                  ? (this._bindAttachment(n, t.attachment), (i = !0))
                  : t.setOCGState
                  ? (this.#Ze(n, t.setOCGState), (i = !0))
                  : t.dest
                  ? (this._bindLink(n, t.dest), (i = !0))
                  : (t.actions &&
                      (t.actions.Action || t.actions["Mouse Up"] || t.actions["Mouse Down"]) &&
                      this.enableScripting &&
                      this.hasJSActions &&
                      (this._bindJSAction(n, t), (i = !0)),
                    t.resetForm
                      ? (this._bindResetFormAction(n, t.resetForm), (i = !0))
                      : this.isTooltipOnly && !i && (this._bindLink(n, ""), (i = !0))),
            ...
            _bindResetFormAction(t, e) {
              const n = t.onclick;
              if (
                (n || (t.href = this.linkService.getAnchorUrl("")), this.#tn(), !this._fieldObjects)
              )
                return (
                  (0, i.warn)(
              ...
              t.onclick = () => {
                ...
                if (0 !== t.length || 0 !== r.length) {
                  ...
                  for (const t of Object.values(this._fieldObjects))
                    for (const n of t) e.has(n.id) === s && a.push(n);
                ...
                for (const t of a) {
                  ...
                  n &&
                    (h.has(n)
                      ...
                      : (0, i.warn)(`_bindResetFormAction - element not allowed: ${e}`));
                }
                return (
                  this.enableScripting &&
                    this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
          ...
          class WidgetAnnotationElement extends AnnotationElement {
            ...
            _setEventListeners(t, e, n, i) {
              for (const [r, s] of n)
                ("Action" === s || this.data.actions?.[s]) &&
                  (("Focus" !== s && "Blur" !== s) || (e ||= { focused: !1 }),
                  this._setEventListener(t, e, r, s, i),
                  "Focus" !== s || this.data.actions?.Blur
                    ? "Blur" !== s ||
            ...
            _setBackgroundColor(t) {
              ...
              t.style.backgroundColor =
                null === e ? "transparent" : i.Util.makeHexColor(e[0], e[1], e[2]);
            }
            _setTextStyle(t) {
          ...
          class TextWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            setPropertyOnSiblings(t, e, n, i) {
              ...
              for (const s of this._getElementsByName(t.name, t.id))
                s.domElement && (s.domElement[e] = n), r.setValue(s.id, { [i]: n });
            }
            render() {
          ...
          class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              "string" == typeof i && ((i = "Off" !== i), t.setValue(n, { value: i })),
            ...
            render() {
              ...
              for (const t of this.data.options) {
                ...
                (e.textContent = t.displayValue),
                  ...
                  n.value.includes(t.exportValue) && (e.setAttribute("selected", !0), (r = !1)),
                  i.append(e);
              }
              let s = null;
              if (r) {
              ...
              const getValue = (t) => {
                ...
                return r
                  ? Array.prototype.filter.call(n, (t) => t.selected).map((t) => t[e])
                  : -1 === n.selectedIndex
                  ? null
                  : n[n.selectedIndex][e];
              };
                  ...
                  ? (i.addEventListener("updatefromsandbox", (n) => {
                      const r = {
                        ...
                        remove(n) {
                          ...
                          t.setValue(e, { value: getValue(!0), items: getItems(n) }),
                            (a = getValue(!1));
                        },
                        clear(n) {
            ...
            render() {
              ...
              return (
                this.container.setAttribute(
                  "aria-controls",
                  e.map((t) => `${i.AnnotationPrefix}${t}`).join(",")
                ),
                this.container
              );
            }
          ...
          class PopupElement {
            ...
            constructor(t) {
              ...
              p &&
                (this.#en = c.l10n.get("annotation_date_string", {
            ...
            render() {
              ...
              if (((a.className = "popup"), this.#Ue)) {
                ...
                if (CSS.supports("background-color", "color-mix(in srgb, red 30%, white)"))
                  ...
                  const t = 0.7;
                  a.style.backgroundColor = i.Util.makeHexColor(
                    ...this.#Ue.map((e) => Math.floor(t * (255 - e) + e))
                  );
                }
              }
              ...
              if (!d?.str || (h?.str && h.str !== d.str)) {
                ...
                l.XfaLayer.render({ xfaHtml: d.html, intent: "richText", div: a }),
            ...
            #in(t) {
              t.altKey ||
                ...
                t.ctrlKey ||
                t.metaKey ||
                (("Enter" === t.key || ("Escape" === t.key && this.#gn)) && this.#cn());
            }
            #cn() {
              (this.#gn = !this.#gn),
                this.#gn
                  ? (this.#on(),
                    ...
                    this.#Rt.addEventListener("keydown", this.#nn))
                  : (this.#sn(),
            ...
            #on() {
              this.#fn || this.render(),
                this.isVisible
                  ? this.#gn && this.#Rt.classList.add("focused")
                  : ((this.#Rt.hidden = !1),
            ...
            render() {
              ...
              e.hasAppearance || 0 === e.fillAlpha
                ...
                : ((n = document.createElement("img")),
                  (n.src = `${this.imageResourcesPath}annotation-${
                    /paperclip/i.test(e.name) ? "paperclip" : "pushpin"
                  }.svg`),
                  e.fillAlpha &&
                    e.fillAlpha < 1 &&
                    (n.style = `filter: opacity(${Math.round(100 * e.fillAlpha)}%);`)),
          ...
          e.AnnotationLayer = class AnnotationLayer {
            ...
            update(t) {
              ...
              const n = this.div;
              (this.viewport = e),
                (0, r.setLayerDimensions)(n, { rotation: e.rotation }),
                this.#Mn(),
                (n.hidden = !1);
            }
            #Mn() {
        ...
        (t, e) => {
          ...
          e.ColorConverters = class ColorConverters {
            ...
            static CMYK_rgb(t) {
              let [e, n, i, r] = t;
              return [
                scaleAndClamp(1 - Math.min(1, e + r)),
                scaleAndClamp(1 - Math.min(1, i + r)),
                scaleAndClamp(1 - Math.min(1, n + r)),
              ];
            }
            static CMYK_HTML(t) {
        ...
        (t, e, n) => {
          ...
          e.XfaLayer = class XfaLayer {
                  ...
                  if ("radio" === n.attributes.type || "checkbox" === n.attributes.type) {
                    if (
                      (s.value === n.attributes.xfaOn
                        ...
                        : s.value === n.attributes.xfaOff && t.removeAttribute("checked"),
                      "print" === r)
                    )
                      break;
                    ...
                    if ((null !== s.value && t.setAttribute("value", s.value), "print" === r))
                      break;
                    t.addEventListener("input", (t) => {
                      i.setValue(e, { value: t.target.value });
                    });
            ...
            static render(t) {
              ...
              r.attributes &&
                this.setAttributes({ html: a, element: r, intent: s, linkService: n });
              const o = [[r, -1, a]],
                l = t.div;
          ...
          class InkEditor extends r.AnnotationEditor {
            ...
            static get defaultPropertiesToUpdate() {
              return [
                ...
                [
                  ...
                  InkEditor._defaultColor || r.AnnotationEditor._defaultLineColor,
                ],
                [
            ...
            rebuild() {
              this.parent &&
                (super.rebuild(),
                null !== this.div &&
                  (this.canvas || (this.#Kn(), this.#Yn()),
                  this.isAttachedToDOM || (this.parent.add(this), this.#Jn()),
                  this.#$n()));
            }
            remove() {
              null !== this.canvas &&
            ...
            #Zn() {
              ...
              (t.lineWidth = (i * r) / s),
                ...
                (t.lineJoin = "round"),
                (t.miterLimit = 10),
                (t.strokeStyle = `${e}${(0, o.opacityToHex)(n)}`);
            }
            #ti(t, e) {
            ...
            #ni(t, e) {
              ...
              let s = this.#Nn;
              if ((r.push([t, e]), (this.#jn = !0), r.length <= 2))
                return s.moveTo(...r[0]), void s.lineTo(t, e);
              3 === r.length && ((this.#Nn = s = new Path2D()), s.moveTo(...r[0])),
              ...
              this.addCommands({
                ...
                undo: () => {
                  this.allRawPaths.pop(),
                    ...
                    0 === this.paths.length
                      ? this.remove()
                      : (this.canvas || (this.#Kn(), this.#Yn()), this.#$n());
                },
                mustExec: !0,
              });
            }
            ...
            static deserialize(t, e, n) {
              ...
              const m = a.#fi();
              return (
                (a.#Rn = Math.max(r.AnnotationEditor.MIN_SIZE, m[2] - m[0])),
        ...
        (t, e, n) => {
          ...
          class StampEditor extends r.AnnotationEditor {
            ...
            #wi(t) {
              ...
              t
                ? ((this.#mi = t.bitmap),
                  e || ((this.#bi = t.id), (this.#Ei = t.isSvg)),
                  this.#Kn())
                : this.remove();
            }
            #Ci() {
            ...
            rebuild() {
              this.parent
                ? (super.rebuild(),
                  null !== this.div &&
                    (this.#bi && this.#Ti(), this.isAttachedToDOM || this.parent.add(this)))
                : this.#bi && this.#Ti();
            }
            onceAdded() {
            ...
            #Kn() {
              ...
              t.append(l),
                ...
                this.#Pi(e, n),
                this.#Yn(),
                this.#xi || (this.parent.addUndoableEditor(this), (this.#xi = !0)),
                this._uiManager._eventBus.dispatch("reporttelemetry", {
                  source: this,
                  details: {
                    type: "editing",
            ...
            serialize() {
              ...
              if (t)
                return (n.bitmapUrl = this.#Fi(!0)), (n.accessibilityData = this.altTextData), n;
              const { decorative: r, altText: s } = this.altTextData;
              if ((!r && s && (n.accessibilityData = { type: "Figure", alt: s }), null === e))
                return n;
              e.stamps ||= new Map();
